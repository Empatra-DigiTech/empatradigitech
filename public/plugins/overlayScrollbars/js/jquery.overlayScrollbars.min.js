    ...
    function z(r, n, t, xt, _t) {
                    ...
                    function U(n, t) {
                        ...
                        if (
                            ...
                            ((i = b ? c - i : i),
                                (i *= y ? -1 : 1),
                                (i =
                                    s && Ot.n ? Oi.min(0, Oi.max(c, i)) : Oi.max(0, Oi.min(c, i))));
                        }
                        return i === f ? hi : i;
                    }
                    function V(n, t, r, e) {
        ...
        function Pe(n, t) {
            if (n) {
                ...
                if (t) {
                    if (A)
                        ((k = n.addClass('observed').append(ai(Sn)).contents()[0])[Z] = new r(
                            a,
                        )).observe(k);
                    else if (9 < I || !kt) {
                        n.prepend(
        ...
        function Xe(n) {
            ...
            if (
                ...
                if (C && !Q) {
                    ...
                    (rr.css(he, nn),
                        (J = Z !== tn) ||
                            (rr.css(he, Z + 1), (tn = ar[xi.oW]), rr.css(he, nn), (J = Z !== tn)));
                }
                var rn = (Q || J) && C && !t,
                    en = f(rn, br),
                    on = !rn && br,
