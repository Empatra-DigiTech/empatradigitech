                    ...
                    return 0 == t
                        ...
                        : 2 == (t /= i / 2)
                          ...
                          : ((u = u || i * (0.3 * 1.5)),
                            (o = f < s.a(e) ? ((f = e), u / 4) : (u / (2 * s.p)) * s.n(e / f)),
                            t < 1
                                ? f * s.w(2, 10 * --t) * s.s(((t * i - o) * (2 * s.p)) / u) * -0.5 +
                                  r
                                : f * s.w(2, -10 * --t) * s.s(((t * i - o) * (2 * s.p)) / u) * 0.5 +
                                  e +
                                  r);
    ...
    function K(r, n, t, xt, _t) {
                    ...
                    function B(n, t) {
                        ...
                        if (
                            ...
                            ((i = b ? c - i : i),
                                (i *= m ? -1 : 1),
                                (i =
                                    s && Ct.n ? Si.min(0, Si.max(c, i)) : Si.max(0, Si.min(c, i))));
                        }
                        return i === a ? di : i;
                    }
                    function Q(n, t, r, e) {
        ...
        function je(n, t) {
            if (n) {
                ...
                if (t) {
                    if (T)
                        ((k = n.addClass('observed').append(ui(On)).contents()[0])[Z] = new r(
                            u,
                        )).observe(k);
                    else if (9 < D || !kt) {
                        n.prepend(
        ...
        function qe(n) {
            ...
            if (
                ...
                if (I && !J) {
                    ...
                    (rr.css(de, nn),
                        (K = Z !== tn) ||
                            (rr.css(de, Z + 1), (tn = ur[xi.oW]), rr.css(de, nn), (K = Z !== tn)));
                }
                var rn = (J || K) && I && !t,
                    en = a(rn, br),
                    on = !rn && br,
