    ...
    Mapael.prototype = {
                ...
                self.$map.on('touchstart.' + pluginName, function (e) {
                    if (e.originalEvent.touches.length === 2) {
                        ...
                        self.previousPinchDist = Math.sqrt(
                            Math.pow(
                                e.originalEvent.touches[1].pageX - e.originalEvent.touches[0].pageX,
                                2,
                            ) +
                                Math.pow(
        ...
        onZoomEvent: function (e, zoomOptions) {
            ...
            if (zoomOptions.area !== undefined) {
                ...
                zoomLevel = Math.min(
                    Math.floor(
                        (self.mapConf.width / areaFullWidth - 1) / self.options.map.zoom.step,
                    ),
                    Math.floor(
                        (self.mapConf.height / areaFullHeight - 1) / self.options.map.zoom.step,
                    ),
                );
            } else {
