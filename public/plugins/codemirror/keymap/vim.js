    ...
    var Vim = function () {
        ...
        var motions = {
            ...
            moveToCharacter: function (cm, head, motionArgs) {
                ...
                return (
                    moveToCharacter(cm, repeat, motionArgs.forward, motionArgs.selectedCharacter) ||
                    head
                );
            },
            moveToSymbol: function (cm, head, motionArgs) {
                var repeat = motionArgs.repeat;
                return (
                    findSymbol(cm, repeat, motionArgs.forward, motionArgs.selectedCharacter) || head
                );
            },
        ...
        function expandTagUnderCursor(cm, head, inclusive) {
            ...
            var tags =
                CodeMirror.findMatchingTag(cm, head) || CodeMirror.findEnclosingTag(cm, head);
                    ...
                    : number == 'decimal'
                      ...
                      : number == 'hex'
                        ...
                        : number == 'octal'
                          ...
                          : null;
                var radix =
                    number == 'decimal' ? 10 : number == 'hex' ? 16 : number == 'octal' ? 8 : null;
                var numPart = [],
                    textPart = [];
                if (number || pattern) {
                    for (var i = 0; i < text.length; i++) {
