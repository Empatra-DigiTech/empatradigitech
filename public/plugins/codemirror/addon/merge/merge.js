...
(function (mod) {
    ...
    function drawConnectorsForChunk(dv, chunk, sTopOrig, sTopEdit, w) {
        ...
        if (dv.svg) {
            ...
            var curveTop =
                ...
                topLpx;
            var curveBot =
                ' C ' + w / 2 + ' ' + botLpx + ' ' + w / 2 + ' ' + botRpx + ' -1 ' + botRpx;
            attrs(
    ...
    function copyChunk(dv, to, from, chunk) {
        ...
        var editStart =
            chunk.editTo > to.lastLine() ? Pos(chunk.editFrom - 1) : Pos(chunk.editFrom, 0);
    ...
    function getChunks(diff) {
        ...
        for (var i = 0; i < diff.length; ++i) {
            ...
            if (tp == DIFF_EQUAL) {
                var startOff =
                    !startOfLineClean(diff, i) || edit.line < startEdit || orig.line < startOrig
                        ? 1
                        : 0;
