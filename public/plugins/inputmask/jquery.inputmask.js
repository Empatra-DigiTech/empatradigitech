                                ...
                                if ((((s = m.pop()).openGroup = !1), void 0 !== s))
                                    if (m.length > 0) {
                                        if (
                                            ...
                                            for (
                                                var e = (u = m.pop()).matches[0].matches
                        ...
                        (t.determineLastRequiredPosition = function (e) {
                            ...
                            for (t = f + 1; t < u.length; t++)
                                ((i = a.getTestTemplate.call(r, t, h, t - 1)),
                                    ...
                                    (d[t] = l.extend(!0, {}, i)));
                            var m =
                                p && void 0 !== p.alternation ? p.locator[p.alternation] : void 0;
                            for (
                                t = c - 1;
                                t > f &&
                            ...
                            if (void 0 === r.validPositions[l] && !o.isMask.call(a, l, !1))
                                if (0 == l ? n.getTest.call(a, l) : r.validPositions[l - 1]) {
                                    ...
                                    if (
                                        ...
                                        (((f = s.extend({}, f, {
                                            input:
                                                n.getPlaceholder.call(a, l, f.match, !0) ||
                                                f.match.def,
                                        })).generatedInput = !0),
                                        v.call(a, l, f, !0),
                                        !0 !== i)
