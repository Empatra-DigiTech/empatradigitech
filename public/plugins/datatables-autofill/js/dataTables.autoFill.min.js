...
$jscomp.polyfillUnisolated = function (c, h, g, k) {
    ...
    h != k &&
        null != h &&
        $jscomp.defineProperty(g, c, { configurable: !0, writable: !0, value: h });
};
    ...
    c.extend(r.prototype, {
        ...
        _attach: function (a) {
            ...
            b && -1 !== d.columns(this.c.columns).indexes().indexOf(b.column)
                ? (this.dom.offsetParent ||
                      (this.dom.offsetParent = c(d.table().node()).offsetParent()),
                  (f.height && f.width) ||
                      (e.appendTo('body'),
            ...
            if (1 === f.length && !1 === this.c.alwaysAsk) {
                ...
                c.each(f, function (p, q) {
                    n.append(
                        c('<li/>')
                            .append(
                                '<div class="dt-autofill-question">' + e[q].option(b, a) + '<div>',
                            )
                            .append(
        ...
        _drawSelection: function (a, d) {
            ...
            var e = c(this.dom.start),
                f = {
                    row: this.c.vertical
                        ? b.rows({ page: 'current' }).nodes().indexOf(a.parentNode)
                        : d.row,
