...
$jscomp.polyfillUnisolated = function (n, q, l, r) {
    ...
    q != r &&
        null != q &&
        $jscomp.defineProperty(l, n, { configurable: !0, writable: !0, value: q });
};
    ...
    var l,
        ...
        t = (function () {
            ...
            h.prototype.addRow = function (a, b, c, e, d, f, g) {
                ...
                void 0 === k &&
                    ((k = this.s.indexes.length), this.s.indexes.push({ filter: b, index: k }));
            ...
            h.prototype._addOption = function (a, b, c, e, d, f) {
                if (Array.isArray(a) || a instanceof r.Api)
                    if (
                        ...
                        for (var g = 0; g < a.length; g++)
                            (f[a[g]]
                                ? f[a[g]]++
                                : ((f[a[g]] = 1),
                                  d.push({ display: b[g], filter: a[g], sort: c[g], type: e[g] })),
                    ...
                    'string' === typeof this.s.colOpts.orthogonal
                        ? (f[a]
                              ? f[a]++
                              : ((f[a] = 1), d.push({ display: b, filter: a, sort: c, type: e })),
                          this.s.rowData.totalOptions++)
                            ...
                            columnDefs: [
                                {
                                    ...
                                    render: function (C, G, D) {
                                        ...
                                        var E =
                                            ((f.s.filteringActive || f.s.showFiltered) &&
                                                f.c.viewTotal) ||
            ...
            h.prototype._search = function (a, b) {
                for (
                    var c = this.s.colOpts, e = this.s.dt, d = 0, f = this.selections;
                    d < f.length;
                    d++
                ) {
                    var g = f[d];
        ...
        F = (function () {
            function h(a, b, c) {
                ...
                this.dom = {
                    clearAll: v('<button type="button">Clear All</button>').addClass(
                ...
                if (void 0 === d.settings()[0]._searchPanes) {
                    ...
                    this.dom.clearAll.text(
                        d.i18n('searchPanes.clearMessage', this.c.i18n.clearMessage),
                    );
                    this.dom.collapseAll.text(
                        d.i18n('searchPanes.collapseMessage', this.c.i18n.collapseMessage),
                    );
                    this.dom.showAll.text(
                        d.i18n('searchPanes.showMessage', this.c.i18n.showMessage),
                    );
                            ...
                            if (
                                ...
                                for (p = k + 1; p < this.s.selectionList.length; p++)
                                    this.s.selectionList[p].index ===
                                        this.s.selectionList[k].index && (g = !0);
                                g ||
            ...
            h.prototype.resizePanes = function () {
                if ('auto' === this.c.layout) {
                    ...
                    for (d = this.s.panes; b < d.length; b++)
                        ((g = d[b]),
                            g.s.displayed &&
                                ((f = 'columns-' + (e.includes(g.s.index) ? c : a)), g.resize(f)));
                } else
            ...
            h.prototype._cascadeRegen = function (a, b) {
                ...
                for (var e = 0, d = this.s.panes; e < d.length; e++)
                    ((b = d[e]),
                        b.setCascadeRegen(!0),
                        b.setClear(!0),
                        ((void 0 !== b.s.dtPane && b.s.index === c) || void 0 !== b.s.dtPane) &&
                            b.clearPane(),
                        b.setClear(!1));
                this.s.dt.draw();
            ...
            h.prototype._paneDeclare = function (a, b, c) {
                ...
                for (
                    var d = a.columns().eq(0).toArray().length, f = this.c.panes.length, g = 0;
                    g < f;
                    g++
                )
                    this.s.panes.push(
                        new t(b, c, d + g, this.c.layout, this.dom.panes, this.c.panes[g]),
                    );
                ...
                if (a) {
                    ...
                    for (e = 0; e < this.s.selectionList.length; e++) {
                        ...
                        for (a = e + 1; a < this.s.selectionList.length; a++)
                            this.s.selectionList[a].index === this.s.selectionList[e].index &&
                                (d = !0);
                        if (!d) {
                            a = !1;
                            for (var f = 0, g = this.s.panes; f < g.length; f++)
                                ((d = g[f]),
                                    d.s.index === this.s.selectionList[e].index &&
                                        0 <
                                            d.s.dtPane.rows({ selected: !0 }).data().toArray()
                                                .length &&
                                        (a = !0));
