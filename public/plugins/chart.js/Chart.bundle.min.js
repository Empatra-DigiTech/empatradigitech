...
!(function (t, e) {
    ...
    var Wn = _n.extend({
            ...
            handleTickRangeOptions: function () {
                ...
                ((t.min = Nn(e.min, t.min)),
                    ...
                    null === t.max &&
                        (t.max = 0 !== t.min ? Math.pow(10, Math.floor(Ln(t.min)) + 1) : 10),
                    null === t.minNotZero &&
                        (t.min > 0
                            ? (t.minNotZero = t.min)
                            : t.max < 1
    ...
    function li(t, e) {
        ...
        return (
            ...
            null !== o
                ? +o
                : (a || 'function' != typeof r || ((o = r(e)), B.isFinite(o) || (o = n.parse(o))),
                  o)
        );
    }
    function ui(t, e) {
    ...
    var gi = { category: kn, linear: An, logarithmic: Wn, radialLinear: $n, time: ci },
        mi = e(function (e, n) {
            e.exports = (function () {
                ...
                function r(t) {
                    return (
                        t instanceof Array || '[object Array]' === Object.prototype.toString.call(t)
                    );
                }
                function o(t) {
                    return null != t && '[object Object]' === Object.prototype.toString.call(t);
