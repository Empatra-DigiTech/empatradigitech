    ...
    var h,
        ...
        r = (function () {
            ...
            c.prototype.getDetails = function (a) {
                ...
                if (
                    ...
                    if (this.s.type.includes('date') || this.s.type.includes('time'))
                        for (a = 0; a < this.s.value.length; a++)
                            null ===
                                this.s.value[a].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g) &&
                                (this.s.value[a] = '');
            ...
            c.init2Input = function (a, b, d) {
                ...
                a.c.greyscale &&
                    (e[0].addClass(c.classes.greyscale), e[2].addClass(c.classes.greyscale));
            ...
            c.init2Date = function (a, b, d) {
                ...
                a.c.greyscale &&
                    (f[0].addClass(c.classes.greyscale), f[2].addClass(c.classes.greyscale));
            ...
            c.prototype.addCriteria = function (a, b) {
                ...
                for (var f = 0; f < this.s.criteria.length; f++)
                    0 === f && this.s.criteria[f].criteria.s.index > e.s.index
                        ? (e.getNode().insertBefore(this.s.criteria[f].criteria.dom.container),
                          (a = !0))
                        : f < this.s.criteria.length - 1 &&
                          this.s.criteria[f].criteria.s.index < e.s.index &&
                          this.s.criteria[f + 1].criteria.s.index > e.s.index &&
                          (e.getNode().insertAfter(this.s.criteria[f].criteria.dom.container),
                          (a = !0));
