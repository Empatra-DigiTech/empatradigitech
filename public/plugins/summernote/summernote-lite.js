        ...
        (() => {
                                    ...
                                    case TableResultAction.resultAction.SumSpanCount:
                                        {
                                            if (position === 'top') {
                                                ...
                                                if (isTopFromRowSpan) {
                                                    var newTd = external_jQuery_default()(
                                                        '<div></div>',
                                                    )
                                                        .append(
                                                            external_jQuery_default()(
                                        ...
                                        external_jQuery_default().each(
                                            ...
                                            function (idx, type) {
                                                ...
                                                if (type.toLowerCase().indexOf('text') > -1) {
                                                    ...
                                                    external_jQuery_default()(content).each(
                                                        function (idx, item) {
                                                            _this.context.invoke(
                                                                'editor.insertNode',
                                                                item,
                ...
                Buttons_createClass(Buttons, [
                    ...
                    },
                    {
                        ...
                        value: function isFontInstalled(name) {
                            if (
                                !Object.prototype.hasOwnProperty.call(this.fontInstalledMap, name)
                            ) {
                                        ...
                                        this.ui.dropdown({
                                            ...
                                            callback: function callback($dropdown) {
                                                ...
                                                $dropdown
                                                    ...
                                                    .each(function (idx, item) {
                                                        external_jQuery_default()(item).change(
                                                            function () {
                                                                var $chip = $dropdown
                                                                    .find(
                                                                        '#' +
                                    ...
                                    external_jQuery_default().each(
                                        ...
                                        function (idx, fontname) {
                                            ...
                                            if (_this2.isFontDeservedToAdd(fontname)) {
                                                if (
                                                    _this2.options.fontNames.indexOf(fontname) ===
                                                    -1
                                                ) {
                                        ...
                                        ],
                                        {
                                            callback: function callback($node) {
                                                ...
                                                $catcher
                                                    .css({
                                                        width:
                                                            _this2.options.insertTableMaxSize.col +
                                                            'em',
                                                        height:
                                                            _this2.options.insertTableMaxSize.row +
                                                            'em',
                                                    })
                                                    .mouseup(
            ...
            external_jQuery_default()(document).on('click', function (e) {
                if (!external_jQuery_default()(e.target).closest('.note-btn-group').length) {
                    ...
                    external_jQuery_default()('.note-btn-group .note-btn.active').removeClass(
                        'active',
                    );
                }
            });
