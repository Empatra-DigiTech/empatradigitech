            ...
            (() => {
                        ...
                        return t.length
                            ? b(t).reduce(
                                  function (t, n) {
                                      var o = g(t);
                                      return (
                                          e(g(o), n) ? (o[o.length] = n) : (t[t.length] = [n]),
                                          t
                                      );
                                  },
                                  [[m(t)]],
                ...
                const ht = {
                    ...
                    splitPoint: function (t, e) {
                        ...
                        var s =
                            n && st(n, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
                        return (
                                ...
                                value: function (t, n) {
                                    ...
                                    var a = ht.makePredByNodeName(o),
                                        s = t
                                            ...
                                            .map(function (t) {
                                                return (
                                                    ht.singleChildAncestor(t, a) || ht.wrap(t, o)
                                                );
                                            });
                                    if (i) {
                                        if (r) {
                        ...
                        (o = [
                            ...
                            },
                            {
                                ...
                                value: function (t, n, o) {
                                    ...
                                    return (
                                        o && o.tableClassName && u.addClass(o.tableClassName),
                                        u[0]
                                    );
                                },
                            },
                                    ...
                                    e()
                                        ...
                                        .then(function (t) {
                                            (i.beforeCommand(),
                                                ...
                                                i.setLastRange(
                                                    yt.createFromNodeAfter(t[0]).select(),
                                                ),
                                                i.afterCommand());
                                        })
                                        .fail(function (t) {
                                                    ...
                                                    click: function (t) {
                                                        ...
                                                        o && i
                                                            ? r.context.invoke('editor.color', {
                                                                  backColor:
                                                                      n.attr('data-backColor'),
                                                                  foreColor:
                                                                      n.attr('data-foreColor'),
                                                              })
                                                            : o
                                                              ? r.context.invoke('editor.color', {
                                                                    backColor:
                                    ...
                                    (this.context.memo('button.bold', function () {
                                        return t
                                            .button({
                                                ...
                                                tooltip:
                                                    t.lang.font.bold + t.representShortcut('bold'),
                                        ...
                                        if ('words' === this.options.hintMode) {
                                            if (
                                                ...
                                                this.hints.forEach(function (t) {
                                                    if (t.match.test(i))
                                                        return (
                                                            (o = r.getWordsMatchRange(t.match)),
                                                            !1
                                                        );
                                                }),
                                                !o)
