            ...
            (() => {
                        ...
                        return t.length
                            ? b(t).reduce(
                                  function (t, o) {
                                      var n = g(t);
                                      return (
                                          e(g(n), o) ? (n[n.length] = o) : (t[t.length] = [o]),
                                          t
                                      );
                                  },
                                  [[m(t)]],
                ...
                const ht = {
                    ...
                    splitPoint: function (t, e) {
                        ...
                        var s =
                            o && st(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
                        return (
                                ...
                                value: function (e) {
                                    var o = this.getEndPoint(),
                                        n = ht.prevPointUntil(o, function (n) {
                                            if (!ht.isCharPoint(n) && !ht.isSpacePoint(n))
                                                return !0;
                                ...
                                value: function (t, o) {
                                    ...
                                    var a = ht.makePredByNodeName(n),
                                        s = t
                                            ...
                                            .map(function (t) {
                                                return (
                                                    ht.singleChildAncestor(t, a) || ht.wrap(t, n)
                                                );
                                            });
                                    if (i) {
                                        if (r) {
                                        ...
                                        return s.map(function (t) {
                                            ...
                                            return (
                                                e().each(i, function (t, e) {
                                                    (ht.appendChildNodes(n, e.childNodes),
                                                        ht.remove(e));
                                                }),
                                                y.head(o)
                                            );
                                    ...
                                    e()
                                        ...
                                        .then(function (t) {
                                            (i.beforeCommand(),
                                                ...
                                                i.setLastRange(
                                                    kt.createFromNodeAfter(t[0]).select(),
                                                ),
                                                i.afterCommand());
                                        })
                                        .fail(function (t) {
                                                    ...
                                                    click: function (t) {
                                                        ...
                                                        n && i
                                                            ? r.context.invoke('editor.color', {
                                                                  backColor:
                                                                      o.attr('data-backColor'),
                                                                  foreColor:
                                                                      o.attr('data-foreColor'),
                                                              })
                                                            : n
                                                              ? r.context.invoke('editor.color', {
                                                                    backColor:
                        ...
                        function (t, o) {
                            var n = Array.isArray(o.items)
                                ? o.items.map(function (t) {
                                      ...
                                      return (
                                          r.html([lo(o.checkClassName), ' ', i]).data('item', t),
                                          r
                                      );
                                  })
                                : o.items;
