    ...
    Grid.prototype = {
        ...
        _setSortingCss: function () {
            ...
            this._headerRow
                ...
                .eq(fieldIndex)
                .addClass(
                    this._sortOrder === SORT_ORDER_ASC ? this.sortAscClass : this.sortDescClass,
                );
        },
        ...
        _createPages: function () {
            ...
            if (firstDisplayingPage > 1) {
                pages.push(
                    this._createPagerPageNavButton(this.pageNavigatorPrevText, this.showPrevPages),
                );
            }
            ...
            if (firstDisplayingPage + pageButtonCount - 1 < pageCount) {
                pages.push(
                    this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages),
                );
            }
...
(function (jsGrid, $, undefined) {
    ...
    function SelectField(config) {
        ...
        if (config.valueField && config.items.length) {
            ...
            this.valueType =
                typeof firstItemValue === numberValueType ? numberValueType : stringValueType;
        }
        ...
        _createModeSwitchButton: function () {
            ...
            var updateButtonState = $.proxy(function () {
                $button
                    .attr(
                        'title',
                        isInserting ? this.searchModeButtonTooltip : this.insertModeButtonTooltip,
                    )
