                ...
                void 0 ===
                    (n = function (t) {
                        function e(i) {
                            ...
                            if (e.is(i, A))
                                return e._engine.create[c](e, i.splice(0, 3 + e.is(i[0], T))).add(
                                    i,
                                );
                            ...
                            for (d = 0; d < l; d++)
                                for (var x = 0; x < h; x++) {
                                    ...
                                    if (S) {
                                        ...
                                        var T =
                                                v.t +
                                                B((S[_] - v[_]) / (y[_] - v[_])) * (y.t - v.t),
                                            A =
                                                m.t +
                                                B((S[C] - m[C]) / (b[C] - m[C])) * (b.t - m.t);
                                        T >= 0 &&
                                            T <= 1.001 &&
                                            A >= 0 &&
                                            A <= 1.001 &&
                        ...
                        ((e._getContainer = function (t, r, i, n) {
                            ...
                            if (
                                null !=
                                (a = null != n || e.is(t, 'object') ? t : l.doc.getElementById(t))
                            )
                                return a.tagName
                                    ? null == r
                                        ? {
                                              ...
                                              var a = function (e) {
                                                  for (
                                                      ...
                                                      if (e.targetTouches[s].target == t) {
                                                          (((e = e.targetTouches[s]).originalEvent =
                                                              a),
                                                              (e.preventDefault = Ft),
                                    ...
                                    for (
                                        ...
                                        if (((r = qt[o]), p && e.touches)) {
                                            for (var h, u = e.touches.length; u--;)
                                                if (
                                                    (h = e.touches[u]).identifier == r.el._drag.id
                                                ) {
                                                    ((i = h.clientX),
                                                        (n = h.clientY),
                                                        (e.originalEvent
                                ...
                                if ((e.is(a, 'string') && (a = this.getFont(a)), a)) {
                                    ...
                                    for (
                                        var y = a.face.bbox[v](n),
                                            ...
                                            B =
                                                +y[1] +
                                                ('baseline' == o ? b + +a.face.descent : b / 2),
                                            C = 0,
                                            S = c.length;
                                        C < S;
                                        C++
        ...
        function (t, e, r) {
            ...
            ((s = 'hasOwnProperty'),
                ...
                (x.on = function (t, e) {
                    ...
                    for (
                        var r = g(t) ? (g(t[0]) ? t : [t]) : d(t).split(l), i = 0, n = r.length;
                        i < n;
                        i++
                    )
                        !(function (t) {
                                ...
                                B = function (i, a) {
                                    if (
                                        ...
                                        if (a[e]('text')) {
                                            ...
                                            for (
                                                p = 0,
                                                    d = (f = o.getElementsByTagName('tspan'))
                                                        .length;
                                                p < d;
                                                p++
                                            )
                                ...
                                (A.rotate = function (t, e, n) {
                                    ...
                                    if (null != t) {
                                        ...
                                        return (
                                            (this._.dirtyT = 1),
                                            this.transform(
                                                this._.transform.concat([['r', t, e, n]]),
                                            ),
                                            this
                                        );
                                    }
