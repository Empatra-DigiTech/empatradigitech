                                    ...
                                    var p = pathToAbsolute(path),
                                        ...
                                        processPath = function (path, d, pcom) {
                                            ...
                                            switch (path[0]) {
                                                ...
                                                case 'H':
                                                    path = ['C'][concat](
                                                        l2c(d.x, d.y, path[1], d.y),
                                                    );
                                                    break;
                                                case 'V':
                                                    path = ['C'][concat](
                                                        l2c(d.x, d.y, d.x, path[1]),
                                                    );
                                                    break;
                                                case 'Z':
                                            ...
                                            if (from[has](attr)) {
                                                switch (availableAnimAttrs[attr]) {
                                                    ...
                                                    default:
                                                        ...
                                                        now = [];
                                                        i =
                                                            that.paper.customAttributes[attr]
                                                                .length;
                                                        while (i--) {
                                                            now[i] =
                                                                +from2[i] +
                                        ...
                                        function (all, _fx, _fy) {
                                            ...
                                            if (_fx && _fy) {
                                                ...
                                                pow(fx - 0.5, 2) + pow(fy - 0.5, 2) > 0.25 &&
                                                    (fy =
                                                        math.sqrt(0.25 - pow(fx - 0.5, 2)) * dir +
                                                        0.5) &&
                                                    fy != 0.5 &&
                                        ...
                                        if (!marker) {
                                            ...
                                            use = $($('use'), {
                                                ...
                                                transform:
                                                    ...
                                                    h / t +
                                                    ')',
                                                'stroke-width': (1 / ((w / t + h / t) / 2)).toFixed(
                                                    4,
                                                ),
                                            });
                                        ...
                                        switch (att) {
                                            ...
                                            case 'fill-opacity':
                                                if (attrs.gradient) {
                                                    ...
                                                    if (gradient) {
                                                        stops =
                                                            gradient.getElementsByTagName('stop');
                                                        $(stops[stops.length - 1], {
                                                            'stop-opacity': value,
                                                        });
                                                    }
