...
!(function (a, b) {
    ...
    function fa(a, b) {
        return a
            ? c(this._months)
                ...
                : this._months[(this._months.isFormat || oe).test(b) ? 'format' : 'standalone'][
                      a.month()
                  ]
            : c(this._months)
              ? this._months
    ...
    function Kb(a) {
        return (
            this._isUTC &&
                (this.utcOffset(0, a), (this._isUTC = !1), a && this.subtract(Gb(this), 'm')),
            this
        );
    }
    function Lb() {
    ...
    function Mb(a) {
        return (
            !!this.isValid() && ((a = a ? tb(a).utcOffset() : 0), (this.utcOffset() - a) % 60 === 0)
        );
    }
    function Nb() {
        return (
    ...
    function jc() {
        ...
        var a = 'moment',
            b = '';
        this.isLocal() ||
            ((a = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone'), (b = 'Z'));
        var c = '[' + a + '("]',
