...
!(function (a) {
    ...
    function p(a) {
        for (
            var b = a.tagName + a.className + a.src + a.href + a.textContent, c = b.length, d = 0;
            c--;
        )
            d += b.charCodeAt(c);
    ...
    function r(a, b) {
        if (a) {
            ...
            return !(
                ...
                (b.length && ((' ' + a.className + ' ').match(d) || []).length != b.length)
            );
        }
        return !1;
    }
        ...
        ja = s(function (a, b, c) {
            if (c && b.scroll) {
                ...
                if (G !== c && ((F = b.scroll), (G = c), (H = b.scrollFn), F === !0)) {
                    F = c;
                    do if (F.offsetWidth < F.scrollWidth || F.offsetHeight < F.scrollHeight) break;
        ...
        (a.prototype = {
            ...
            _onTapStart: function (a) {
                ...
                if (
                    (v(e),
                    !y &&
                        !((/mousedown|pointerdown/.test(h) && 0 !== a.button) || f.disabled) &&
                        !l.isContentEditable &&
                        ((j = c(j, f.draggable, e)), j && E !== j))
                ) {
                    if (((b = q(j, f.draggable)), 'function' == typeof m)) {
                        if (m.call(this, a, j, this))
                            return (k(d, l, 'filter', j, e, e, b), void (g && a.preventDefault()));
                    } else if (
                        m &&
            ...
            _emulateDragOver: function () {
                if (Q) {
                    ...
                    if (
                        (a &&
                            a.shadowRoot &&
                            ((a = a.shadowRoot.elementFromPoint(Q.clientX, Q.clientY)), (b = a)),
                        b)
                    )
                        do {
                            if (b[V]) {
                ...
                (c._offUpEvents(),
                    ...
                    b
                        ? ('touch' === b
                              ...
                              : (f(X, 'mousemove', c._onTouchMove), f(X, 'mouseup', c._onDrop)),
                          (c._loopId = setInterval(c._emulateDragOver, 50)))
                        : (d && ((d.effectAllowed = 'move'), e.setData && e.setData.call(c, d, y)),
                          f(X, 'drop', c),
                    ...
                    if (
                        ...
                        var t = g.right - g.left,
                            ...
                            v =
                                ...
                                ('flex' == K.display && 0 === K['flex-direction'].indexOf('row')),
                ...
                if (c) {
                    ...
                    (1 === a.nodeType && (a = a.getBoundingClientRect()),
                        ...
                        i(
                            b,
                            'transform',
                            'translate3d(' + (a.left - d.left) + 'px,' + (a.top - d.top) + 'px,0)',
                        ),
                        b.offsetWidth,
            ...
            toArray: function () {
                for (
                    var a, b = [], d = this.el.children, e = 0, f = d.length, g = this.options;
                    e < f;
                    e++
                )
                    ((a = d[e]),
