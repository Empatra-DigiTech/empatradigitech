...
!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
            function i(t, e) {
                return (
                    (!t && !e) || (!(!t || !e) && t.component === e.component && r(t, e) && r(e, t))
                );
            }
            function r(t, e) {
                for (var n in t)
                    ...
                    function e(e, n) {
                        ...
                        return (
                            ...
                            i.eventDraggingClass &&
                                i.eventPointing &&
                                (i.eventDragging = new i.eventDraggingClass(i, i.eventPointing)),
                            i.eventResizingClass &&
                                i.eventPointing &&
                                (i.eventResizing = new i.eventResizingClass(i, i.eventPointing)),
                        ...
                        (t.prototype.getBorderColor = function (t) {
                            ...
                            for (e = 0; e < i.length && !n; e++)
                                n =
                                    ...
                                    i[e].color;
                            return (
                                n || (n = this.opt('eventBorderColor') || this.opt('eventColor')),
                                n
                            );
                        }),
                ...
                u = (function (t) {
                    ...
                    return (
                        ...
                        (e.parse = function (t, e) {
                            var n;
                            return (
                                r.isArray(t.events) ? (n = t) : r.isArray(t) && (n = { events: t }),
                        ...
                        (e.prototype.updateDayTable = function () {
                            for (
                                var t,
                                    ...
                                    a = o.msToUtcMoment(i.dateProfile.renderUnzonedRange.endMs, !0),
                                    l = -1,
                                    u = [],
                                    d = [];
                                s.isBefore(a);
                                ...
                                for (
                                    ...
                                    if (u) {
                                        for (
                                            ...
                                            ((g = r('<td class="fc-more-cell"/>').attr(
                                                'rowspan',
                                                p,
                                            )),
                                                (l = d[f]),
                        ...
                        (t.prototype.parseFootprints = function (t) {
                            ...
                            return (
                                t.start &&
                                    ...
                                    e.isValid() || (e = null)),
                                t.end &&
                                    ((n = this._calendar.moment(t.end)), n.isValid() || (n = null)),
                                [
                                    new s.default(
                                        new o.default(e, n),
                    ...
                    function e(n, i) {
                        ...
                        return (
                            ...
                            r.helperRendererClass &&
                                r.eventRenderer &&
                                (r.helperRenderer = new r.helperRendererClass(r, r.eventRenderer)),
                    ...
                    return (
                        ...
                        (t.prototype.initialRender = function () {
                            ...
                            (e.addClass('fc'),
                                ...
                                (this.contentEl = r("<div class='fc-view-container'/>").prependTo(
                                    e,
                                )),
                                this.initToolbars(),
                                this.renderHeader(),
                                ...
                                this.optionsManager.watch(
                                    ...
                                    function (e) {
                                        ...
                                        (e.monthNames && (o._months = e.monthNames),
                                            e.monthNamesShort &&
                                                (o._monthsShort = e.monthNamesShort),
                                                ...
                                                : ((l = d[s])
                                                  ...
                                                  g &&
                                                      ...
                                                      (w = i(
                                                          ...
                                                          .click(function (t) {
                                                              w.hasClass(
                                                                  o.getClass('stateDisabled'),
                                                              ) ||
                                                                  (g(t),
                                                                  (w.hasClass(
                                                                      o.getClass('stateActive'),
                                                                  ) ||
                                                                      w.hasClass(
                                                                          o.getClass(
                                                                              'stateDisabled',
                    ...
                    return (
                        ...
                        (t.prototype.buildViewSpecButtonText = function (t, e) {
                            ...
                            ((t.buttonTextOverride =
                                n(i.dynamicOverrides) || n(i.overrides) || t.overrides.buttonText),
                                (t.buttonTextDefault =
                                    n(i.localeDefaults) ||
                                    n(i.dirDefaults) ||
                                ...
                                if (
                                    ...
                                    for (l = 0; l < r.length; l++) {
                                        for (
                                            u = r[l],
                                                n(u.leftCol),
                                                d = s('<td class="fc-event-container"/>').append(
                                                    u.el,
                                                ),
                    ...
                    return (
                        ...
                        (e.prototype.renderFillRow = function (t, e) {
                            ...
                            return (
                                ...
                                (i = r(
                                    '<div class="fc-' + n + '-skeleton"><table><tr/></table></div>',
                                )),
                                (o = i.find('tr')),
