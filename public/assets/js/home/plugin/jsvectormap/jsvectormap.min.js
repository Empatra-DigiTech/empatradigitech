        ...
        C = (function (e) {
            ...
            return (
                (s._createRegion = function (t, e, i) {
                    return (
                        (t = this._map.canvas.createPath({ d: t, dataCode: e }, i)).addClass(
                    ...
                    for (var a = 0; a < e.length; a++) {
                        ...
                        switch (this._series.config.attribute) {
                            ...
                            case 'image':
                                ((r.style.background =
                                    'url(' +
                                    ('object' == typeof e[a].value ? e[a].value.url : e[a].value) +
    ...
    var T = {
            ...
            _createRegions: function () {
                for (var t in ((this._regionLabelsGroup =
                    this._regionLabelsGroup || this.canvas.createGroup('jvm-regions-labels-group')),
                this._mapData.paths)) {
                    var e = new C({
                        map: this,
                        code: t,
            ...
            _applyTransform: function () {
                ...
                (this._defaultWidth * this.scale <= this._width
                    ...
                    this._defaultHeight * this.scale <= this._height
                        ? ((e =
                              (this._height - this._defaultHeight * this.scale) / (2 * this.scale)),
                          (s =
                              (this._height - this._defaultHeight * this.scale) / (2 * this.scale)))
                        : ((e = 0),
                ...
                (t > this.params.zoomMax * this._baseScale
                    ...
                    void 0 !== e &&
                        ...
                        s
                            ? ((d =
                                  e +
                                  (this._defaultWidth * (this._width / (this._defaultWidth * t))) /
                                      2),
                              (f =
                                  i +
                                  (this._defaultHeight *
            ...
            return (
                ...
                (e.extend = function (e, i) {
                    if ('function' == typeof this[e])
                        throw new Error(
                            'The method [' + e + '] does already exist, please use another name.',
                        );
                    t.prototype[e] = i;
                }),
