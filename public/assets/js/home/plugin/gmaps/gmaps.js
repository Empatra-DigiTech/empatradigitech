...
!(function (e, t) {
            ...
            (o = function (e) {
                ...
                var O = function (e, t) {
                    ...
                    for (var i in n)
                        if (n.hasOwnProperty(i)) {
                            var r = n[i];
                            o +=
                                '<li><a id="' + e + '_' + i + '" href="#">' + r.title + '</a></li>';
                        }
                ...
                (google.maps.event.addListener(this.map, 'rightclick', function (t) {
                    (e.rightclick && e.rightclick.apply(this, [t]),
                        void 0 != window.context_menu[s.el.id].map && s.buildContextMenu('map', t));
                }),
    ...
    return (
                ...
                !(function (t, o, n) {
                    e[n] &&
                        google.maps.event.addListener(o, n, function (o) {
                            (o.pixel || (o.pixel = t.getProjection().fromLatLngToPoint(o.latLng)),
                                e[n].apply(this, [o]));
                        });
                })(this.map, l, h[c]);
            return (
        ...
        (c.prototype.drawCircle = function (e) {
            (delete (e = r({ map: this.map, center: new google.maps.LatLng(e.lat, e.lng) }, e)).lat,
                delete e.lng);
            for (
        ...
        (c.prototype.drawPolygon = function (e) {
            ...
            (e.hasOwnProperty('useGeoJSON') && (t = e.useGeoJSON),
                ...
                e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = a(s(e.paths, l, t))));
            for (
        ...
        (c.prototype.getElevations = function (e) {
            (e = r({ locations: [], path: !1, samples: 256 }, e)).locations.length > 0 &&
        ...
        (c.staticMapURL = function (e) {
            ...
            if ((delete e.polyline, e.center)) (o.push('center=' + e.center), delete e.center);
                ...
                (o.push(['center=', e.lat, ',', e.lng].join('')), delete e.lat, delete e.lng);
            else if (e.visible) {
            ...
            if (r)
                for (d = 0; d < r.length; d++) {
                    var u = [];
                    (r[d].featureType && u.push('feature:' + r[d].featureType.toLowerCase()),
                        r[d].elementType && u.push('element:' + r[d].elementType.toLowerCase()));
        ...
        (c.on = function (e, t, o) {
            if (-1 == c.custom_events.indexOf(e))
                return (t instanceof c && (t = t.map), google.maps.event.addListener(t, e, o));
        ...
        (c.off = function (e, t) {
            -1 == c.custom_events.indexOf(e)
                ? (t instanceof c && (t = t.map), google.maps.event.clearListeners(t, e))
                : (t.registered_events[e] = []);
        }),
        (c.once = function (e, t, o) {
            if (-1 == c.custom_events.indexOf(e))
                return (t instanceof c && (t = t.map), google.maps.event.addListenerOnce(t, e, o));
        }),
        ...
        'object' == typeof window.google &&
            ...
            (google.maps.Polygon.prototype.getBounds ||
                (google.maps.Polygon.prototype.getBounds = function (e) {
                    for (
                        var t, o = new google.maps.LatLngBounds(), n = this.getPaths(), i = 0;
                        i < n.getLength();
                        i++
                    ) {
                        t = n.getAt(i);
            ...
            google.maps.Polygon.prototype.containsLatLng ||
                (google.maps.Polygon.prototype.containsLatLng = function (e) {
                    ...
                    for (var o = !1, n = this.getPaths().getLength(), i = 0; i < n; i++)
                        for (
                            var r = this.getPaths().getAt(i), s = r.getLength(), a = s - 1, l = 0;
                            l < s;
                            l++
                        ) {
                            var p = r.getAt(l),
