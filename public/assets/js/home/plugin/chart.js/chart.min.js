    ...
    'undefined' == typeof Chart
        ...
        : ((t.prototype.beforeDatasetsUpdate = function (t) {
          ...
          (t.prototype.afterDatasetsDraw = function (t) {
              this.parseOptions(t) &&
                  ((this.labelBounds = []), t.config.data.datasets.forEach(this.drawDataset));
          }),
                  ...
                  if (0 !== n.circumference || this.showZero) {
                      ...
                      if (
                          ...
                          if (
                              ('border' === this.position
                                  ...
                                  : 'outside' === this.position && (f = n.outerRadius - c + c + p),
                      ...
                      if (
                          ('function' == typeof (p = this.fontColor)
                              ...
                              : 'string' != typeof p && (p = p[s] || this.options.defaultFontColor),
                          this.arc)
                      )
          ...
          (t.prototype.checkTextBound = function (t, e, i, o) {
              for (var a = this.labelBounds, s = 0; s < a.length; ++s) {
                  ...
                  for (
                      ...
                      if (((l = n[h][0]), (f = n[h][1]), l >= t && l <= e && f >= i && f <= o))
                          return !1;
              }
          ...
          (t.prototype.fillText = function (t, e, i) {
              var o = this.ctx;
              'object' == typeof t
                  ? o.drawImage(t, e.x - t.width / 2, e.y - t.height / 2, t.width, t.height)
                  : ((o.fillStyle = i),
                    (o.textBaseline = 'top'),
                    (o.textAlign = 'center'),
          ...
          (t.prototype.drawArcText = function (t, e, i, o) {
              ...
              var h = (n += Math.PI / 2);
              if (
                  ((n += ((i += Math.PI / 2) - ((s = this.measureText(t)).width / e + n)) / 2),
                  o || !(i - n > r))
              )
                  if ('string' == typeof t)
