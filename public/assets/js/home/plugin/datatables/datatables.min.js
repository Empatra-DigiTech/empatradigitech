...
!(function (t) {
    ...
    function r(e) {
        ...
        (t.each(e, function (t) {
            (n = t.match(/^([^A-Z]+?)([A-Z])/)) &&
                ...
                ((a = t.replace(n[0], n[2].toLowerCase())), (o[a] = t), 'o' === n[1] && r(e[t]));
        }),
            (e._hungarianMap = o));
    }
    function o(e, n, i) {
    ...
    function c(t, e, n, r, o, i) {
        var l,
            s = !1;
        for (n !== a && ((l = n), (s = !0)); r !== o;)
            t.hasOwnProperty(r) && ((l = s ? e(l, t[r], r, t) : t[r]), (s = !0), (r += i));
        return l;
    }
    function f(e, a) {
    ...
    function L(t, e, n, r) {
        ...
        if (((i._aSortData = null), (i._aFilterData = null), (l = t.aoColumns), r !== a))
            l[r].sType = null;
        else {
    ...
    function R(e, n, r, o) {
        ...
        if (c)
            for (; c;)
                (('TD' != (i = c.nodeName.toUpperCase()) && 'TH' != i) || (g(c), u.push(c)),
                    (c = c.nextSibling));
        else for (c = 0, i = (u = n.anCells).length; c < i; c++) g(u[c]);
        return (
            (n = n.firstChild ? n : n.nTr) && (n = n.getAttribute('id')) && x(e.rowId)(o, n),
            { data: o, cells: u }
        );
    }
    function P(e, a, r, o) {
    ...
    function q(e) {
        var a = e.oClasses,
            ...
            c =
                ((a = t('<div/>', { id: l.f ? null : r + '_filter', class: a.sFilter }).append(
                    t('<label/>').append(u),
                )),
                (l = function () {
        ...
        ((r = m.scrollHeight > m.clientHeight),
            e.scrollBarVis !== r && e.scrollBarVis !== a
                ...
                : ((e.scrollBarVis = r),
                  ...
                  T.outerWidth() < d
                      ? ((n =
                            m.scrollHeight > m.offsetHeight || 'scroll' == v.css('overflow-y')
                                ? d + f
                                : d),
                        F &&
                            (m.scrollHeight > m.offsetHeight || 'scroll' == v.css('overflow-y')) &&
    ...
    function gt(n) {
        var a,
            ...
            D = n.oBrowser,
            y = D.bScrollOversize;
        for ((a = o.style.width) && -1 !== a.indexOf('%') && (g = a), a = 0; a < f.length; a++)
            ((r = i[f[a]]), null !== r.sWidth && ((r.sWidth = bt(r.sWidthOrig, m)), (v = !0)));
        if (y || (!v && !s && !l && c == b(n) && c == d.length))
            ...
            for (
                ...
                ((r = i[f[a]]),
                    (d[a].style.width =
                        null !== r.sWidthOrig && '' !== r.sWidthOrig ? vt(r.sWidthOrig) : ''),
                    r.sWidthOrig &&
                        s &&
                        t(d[a]).append(
                            t('<div/>').css({
    ...
    function _t(t) {
        for (
            var e, n, a = t.aoColumns, r = Dt(t), o = ((t = t.oLanguage.oAria), 0), i = a.length;
            o < i;
            o++
        ) {
    ...
    function wt(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            ...
            for (l = 0, n = i.length; l < n; l++)
                ((a = i[l].src), t(re(e.aoData, 'anCells', a)).addClass(o + (2 > l ? l + 1 : 3)));
        }
        e.aLastSort = i;
    }
    function xt(t, e) {
        ...
        for (var o, i = qt.ext.type.order[a.sType + '-pre'], l = 0, s = t.aoData.length; l < s; l++)
            ((a = t.aoData[l]),
                ...
                (!a._aSortData[e] || r) &&
                    ((o = r ? n[l] : _(t, l, e, 'sort')), (a._aSortData[e] = i ? i(o) : o)));
    }
    function It(e) {
    ...
    function Lt(t, n, a, r) {
        if (
            ((a = 'DataTables warning: ' + (t ? 'table id=' + t.sTableId + ' - ' : '') + a),
            r &&
                (a +=
        ...
        for (o in n)
            n.hasOwnProperty(o) &&
                ...
                t.isPlainObject(r)
                    ...
                    : (e[o] = a && 'data' !== o && 'aaData' !== o && t.isArray(r) ? r.slice() : r));
        return e;
    }
    function jt(e, n, a) {
        t(e)
                        ...
                        p = function () {
                            ...
                            if (
                                ...
                                0 === n.length || 0 === n.children().length
                                    ...
                                    : n.length > 0 && ((I.nTFoot = n[0]), W(I.aoFooter, I.nTFoot)),
                                g.aaData)
                            )
    ...
    ((Vt = function (e, n) {
        ...
        t.extend(Vt.prototype, {
            ...
            iterator: function (t, e, n, r) {
                ...
                return d.length || r
                    ? (((e = (t = new Vt(h, t ? d.concat.apply([], d) : d)).selector).rows =
                          p.rows),
                      (e.cols = p.cols),
                      (e.opts = p.opts),
                      t)
            ...
            function (e, n) {
                if (t.isArray(e)) for (var a = 0, r = e.length; a < r; a++) Vt.register(e[a], n);
                    ...
                    for (a = 0, r = l.length; a < r; a++) {
                        ...
                        (u || ((u = { name: o, val: {}, methodExt: [], propExt: [] }), s.push(u)),
    ...
    var De = function (e, n, r, o, i) {
            ...
            for (
                ...
                for (
                    f = 0,
                        d = (s =
                            n[u] && n[u].split && !n[u].match(/[\[\(:]/) ? n[u].split(',') : [n[u]])
                            .length;
                    f < d;
                    f++
                )
    ...
    (Xt('columns()', function (e, n) {
        ...
        Xt('cell().data()', function (t) {
            ...
            return t === a
                ? e.length && n.length
                    ...
                    : a
                : (C(e[0], n[0].row, n[0].column, t), L(e[0], n[0].row, 'data', n[0].column), this);
        }),
        Xt('order()', function (e, n) {
            ...
            return e === a
                ...
                : ('number' == typeof e
                      ? (e = [[e, n]])
                      : e.length && !t.isArray(e[0]) && (e = Array.prototype.slice.call(arguments)),
                  this.iterator('table', function (t) {
                      t.aaSorting = e.slice();
                  }));
        }),
        ...
        (qt.versionCheck = qt.fnVersionCheck =
            function (t) {
                for (
                    var e, n, a = qt.version.split('.'), r = 0, o = (t = t.split('.')).length;
                    r < o;
                    r++
                )
                    if (((e = parseInt(a[r], 10) || 0), (n = parseInt(t[r], 10) || 0), e !== n))
                        return e > n;
                return !0;
            }),
                ...
                _: function (e, n, a, r) {
                    t(e.nTable).on('order.dt.DT', function (t, o, i, l) {
                        e === o &&
                            ((t = a.idx),
                            n
                                .removeClass(a.sSortingClass + ' ' + r.sSortAsc + ' ' + r.sSortDesc)
                                .addClass(
                                    'asc' == l[t]
                                        ? r.sSortAsc
                                        : 'desc' == l[t]
