...
!(function (a) {
        ...
        function h() {
            (c.addClass('fc'),
                ...
                T.options.handleWindowResize &&
                    ((_ = ja(r, T.options.windowResizeDelay)), a(window).resize(_)));
        }
        function i() {
        ...
        function l(b, c) {
            (ga++,
                ...
                !Z &&
                    ...
                    Z.setElement(a("<div class='fc-view fc-" + b + "-view' />").appendTo(W)),
                    V.activateButton(b)),
                Z &&
                    ((aa = Z.massageCurrentDate(aa)),
                    (Z.displaying && aa.isWithin(Z.intervalStart, Z.intervalEnd)) ||
    ...
    function Ua() {
        ...
        function e(a, b) {
            var c, d;
            for (
                'reset' === b ? (da = []) : 'add' !== b && (da = u(da, a)), c = 0;
                c < a.length;
                c++
            )
                ((d = a[c]),
        ...
        function C(c, d) {
            ...
            if (
                ...
                (f && ((f = U.moment(f)), f.isValid() || (f = null)),
                    (g = c.allDay),
                    void 0 === g && (g = ba(d ? d.allDayDefault : void 0, U.options.allDayDefault)),
                    D(e, f, g, h));
            }
        ...
        function F(a) {
            (null == a.allDay && (a.allDay = !(a.start.hasTime() || (a.end && a.end.hasTime()))),
                a.allDay
                    ...
                    : (a.start.hasTime() || (a.start = U.applyTimezone(a.start.time(0))),
                      a.end && !a.end.hasTime() && (a.end = U.applyTimezone(a.end.time(0)))));
        }
        function G(b, c, d) {
            var e,
                f,
        ...
        function J(b) {
            ...
            return (
                ...
                c ? (b && ((c.start = null), (c.end = null)), G(C(c), f.start, f.end)) : []
            );
        }
        function K(a, b) {
            var c = b.source || {},
        ...
        var W,
            ...
            da = [];
        (a.each(
            (U.options.events ? [U.options.events] : []).concat(U.options.eventSources || []),
            function (a, b) {
                var c = k(b);
                c && $.push(c);
            },
            ...
            (U.rezoneArrayEventSources = function () {
                var b, c, d;
                for (b = 0; b < $.length; b++)
                    if (((c = $[b].events), a.isArray(c))) for (d = 0; d < c.length; d++) B(c[d]);
            }),
    ...
    var rb = qb.extend({
            ...
            queryHit: function (a, b) {
                return (
                    this.coordAdjust && ((a += this.coordAdjust.left), (b += this.coordAdjust.top)),
            ...
            return (
                g.hasTime() === h.hasTime()
                    ? ((d = this.diffDates(h, g)),
                      c.allDay && T(d)
                          ? ((e = { start: c.start.clone(), end: f.getEventEnd(c), allDay: !1 }),
            ...
            return (
                ...
                e.start.isBefore(e.end) ||
                    ((f =
                        ...
                        (d.allDay ? g.defaultAllDayEventDuration : g.defaultTimedEventDuration)),
                    'start' == a
        ...
        getSegSkinCss: function (a) {
            ...
            return {
                'background-color':
                    ...
                    g,
                'border-color':
                    b.borderColor || e || d.borderColor || f || c.opt('eventBorderColor') || g,
    ...
    var ub = (Wa.DayTableMixin = {
            ...
            updateDayTable: function () {
                for (
                    var a, b, c, d = this.view, e = this.start.clone(), f = -1, g = [], h = [];
                    e.isBefore(this.end);
                )
                    (d.isHiddenDay(e) ? g.push(f + 0.5) : (f++, g.push(f), h.push(e.clone())),
                        e.add(1, 'days'));
            ...
            limitRow: function (b, c) {
                ...
                if (c && c < u.segLevels.length) {
                    for (
                        ...
                        if (k) {
                            for (
                                m = f[c - 1][i.leftCol], n = m.attr('rowspan') || 1, o = [], p = 0;
                                p < l.length;
                                p++
                            )
    ...
    var wb = (Wa.TimeGrid = tb.extend(ub, {
        ...
        renderSlatRowHtml: function () {
            for (
                var a, c, d, e = this.view, f = this.isRTL, g = '', h = b.duration(+this.minTime);
                h < this.maxTime;
            )
    ...
    var xb = (Wa.View = ya.extend(lb, mb, {
            ...
            trigger: function (a, b) {
                ...
                return c.trigger.apply(
                    c,
                    [a, b || this].concat(Array.prototype.slice.call(arguments, 2), [this]),
                );
            },
            setDate: function (a) {
            ...
            startNowIndicator: function () {
                ...
                this.opt('nowIndicator') &&
                    ...
                    a &&
                        ...
                        (d =
                            this.initialNowDate.clone().startOf(a).add(1, a) - this.initialNowDate),
        ...
        zb = (Wa.Calendar = ya.extend({
            ...
            buildViewSpec: function (a) {
                for (
                    var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a;
                    l;
                )
                    ((d = Xa[l]),
                        (e = h[l]),
                    ...
                    d['class']
                        ? (f &&
                              ...
                              f.valueOf() &&
                                  ((d.duration = f),
                                  (g = O(f)),
                                  1 === f.as(g) && ((d.singleUnit = g), k.unshift(h[g] || {})))),
                          (d.defaults = c(j)),
                          (d.overrides = c(k)),
            ...
            buildViewSpecButtonText: function (a, b) {
                ...
                ((a.buttonTextOverride =
                    c(this.dynamicOverrides) || c(this.overrides) || a.overrides.buttonText),
                    (a.buttonTextDefault =
                        c(this.langDefaults) ||
                        c(this.dirDefaults) ||
    ...
    ((Xa.basic = { class: Gb }),
        ...
        (Xa.month = { class: Ib, duration: { months: 1 }, defaults: { fixedWeekCount: !0 } }));
