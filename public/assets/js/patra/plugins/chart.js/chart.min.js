            ...
            function (t, e, i) {
                ...
                function R(t) {
                    ...
                    return (
                        ...
                        (e =
                            e > 0.0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : (e = 12.92 * e)),
                        (i =
                            i > 0.0031308 ? 1.055 * Math.pow(i, 1 / 2.4) - 0.055 : (i = 12.92 * i)),
                        (a =
                            a > 0.0031308 ? 1.055 * Math.pow(a, 1 / 2.4) - 0.055 : (a = 12.92 * a)),
                ...
                function L(t) {
                    ...
                    return (
                        ...
                        (a =
                            0.008859 >= a / 108.883
                                ? (a = (108.883 * (o - s / 200 - 16 / 116)) / 7.787)
            ...
            function (t, e, i) {
                ...
                e.exports = function (t) {
                    t.Radar = function (e, i) {
                        return (
                            (i.options = t.helpers.configMerge({ aspectRatio: 1 }, i.options)),
                            (i.type = 'radar'),
                            new t(e, i)
                        );
                    };
                            ...
                            updateElement: function (t, i, a) {
                                ...
                                e.extend(t, {
                                    ...
                                    _model: {
                                        ...
                                        y: a
                                            ? r.getBasePixel()
                                            : r.getPixelForValue(h, i, this.index),
                                    ...
                                    return i.labels.length && i.datasets.length
                                        ? i.labels.map(function (a, o) {
                                              var n = t.getDatasetMeta(0),
                                                  ...
                                                  c = l.backgroundColor
                                                      ? l.backgroundColor
                                                      : h(r.backgroundColor, o, d.backgroundColor),
                                                  u = l.borderColor
                                                      ? l.borderColor
                                                      : h(r.borderColor, o, d.borderColor),
                                                  f = l.borderWidth
                                                      ? l.borderWidth
                                                      : h(r.borderWidth, o, d.borderWidth);
                                              return {
                                                  text: a,
                                                  fillStyle: c,
                                                  strokeStyle: u,
                            ...
                            t.DatasetController.extend({
                                ...
                                update: function (t) {
                                    ...
                                    ((a.outerRadius = Math.max(h / 2, 0)),
                                        ...
                                        (i.outerRadius =
                                            a.outerRadius -
                                            a.radiusLength * i.getRingIndex(i.index)),
                                ...
                                updateElement: function (t, i, a) {
                                    var o = this,
                                        ...
                                        p =
                                            a && l.animateRotate
                                                ...
                                                : t.hidden
                                                  ? 0
                                                  : o.calculateCircumference(g.data[i]) *
                                    ...
                                    ((y.backgroundColor = v.backgroundColor
                                        ? v.backgroundColor
                                        : x(g.backgroundColor, i, h.backgroundColor)),
                                        ...
                                        (y.borderWidth = v.borderWidth
                                            ? v.borderWidth
                                            : x(g.borderWidth, i, h.borderWidth)),
                                        (y.borderColor = v.borderColor
                                            ? v.borderColor
                                            : x(g.borderColor, i, h.borderColor)),
                                        (a && l.animateRotate) ||
                                            (0 === i
                                                ? (y.startAngle = s.rotation)
                                                : (y.startAngle =
                                                      o.getMeta().data[i - 1]._model.endAngle),
                        ...
                        (t.controllers.line = t.DatasetController.extend({
                                ...
                                for (
                                    d.showLines &&
                                        ...
                                        (l._model = {
                                            tension: n.tension
                                                ? n.tension
                                                : e.getValueOrDefault(o.lineTension, c.tension),
                                            ...
                                            borderCapStyle: n.borderCapStyle
                                                ? n.borderCapStyle
                                                : o.borderCapStyle || c.borderCapStyle,
                                            borderDash: n.borderDash
                                                ? n.borderDash
                                                : o.borderDash || c.borderDash,
                                            borderDashOffset: n.borderDashOffset
                                                ? n.borderDashOffset
                                                : o.borderDashOffset || c.borderDashOffset,
                                            borderJoinStyle: n.borderJoinStyle
                                                ? n.borderJoinStyle
                                                : o.borderJoinStyle || c.borderJoinStyle,
                                            fill: n.fill
                                                ? n.fill
                                                : void 0 !== o.fill
                                                  ? o.fill
                            ...
                            updateElement: function (t, i, a) {
                                ...
                                (void 0 !== h.radius &&
                                    ...
                                    (n = a
                                        ? u.getBasePixel()
                                        : r.calculatePointY(c, i, d, r.chart.isCombo)),
                                    (t._xScale = f),
                                    (t._yScale = u),
                                    (t._datasetIndex = d),
                                    (t._index = i),
                                    (t._model = {
                                        ...
                                        radius:
                                            l.radius ||
                                            e.getValueAtIndexOrDefault(h.pointRadius, i, g.radius),
                                        pointStyle:
                                            l.pointStyle ||
                                            e.getValueAtIndexOrDefault(
                                                h.pointStyle,
                            ...
                            draw: function (t) {
                                ...
                                for (
                                    this.chart.options.showLines && a.dataset.transition(n).draw(),
                                        e = 0,
                                        i = o.length;
                                    i > e;
                                    ++e
                        ...
                        (t.controllers.polarArea = t.DatasetController.extend({
                            ...
                            update: function (t) {
                                ...
                                ((a.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                                    (a.innerRadius = Math.max(
                                        r.cutoutPercentage
                                            ? (a.outerRadius / 100) * r.cutoutPercentage
                                            : 1,
                                        0,
                                    )),
                                    (a.radiusLength =
                                ...
                                var k = t.hidden ? 0 : u.getDistanceFromCenterForValue(s.data[i]),
                                    ...
                                    w = {
                                        ...
                                        outerRadius: h.animateScale
                                            ? 0
                                            : u.getDistanceFromCenterForValue(s.data[i]),
                                        startAngle: h.animateRotate ? Math.PI * -0.5 : S,
                                        endAngle: h.animateRotate ? Math.PI * -0.5 : C,
                                        backgroundColor: c.backgroundColor
                                            ? c.backgroundColor
                                            : f(s.backgroundColor, i, d.backgroundColor),
                                        borderWidth: c.borderWidth
                                            ? c.borderWidth
                                            : f(s.borderWidth, i, d.borderWidth),
                                        borderColor: c.borderColor
                                            ? c.borderColor
                                            : f(s.borderColor, i, d.borderColor),
                                        label: f(g, i, g[i]),
                                    };
                                (e.extend(t, {
                                    _datasetIndex: o.index,
                    ...
                    ((t.defaults.radar = {
                        ...
                        (t.controllers.radar = t.DatasetController.extend({
                                ...
                                (void 0 !== r.tension &&
                                    ...
                                    e.extend(i.dataset, {
                                        ...
                                        _model: {
                                            tension: n.tension
                                                ? n.tension
                                                : e.getValueOrDefault(r.lineTension, s.tension),
                                            backgroundColor: n.backgroundColor
                                                ? n.backgroundColor
                            ...
                            updateBezierControlPoints: function () {
                                ...
                                e.each(
                                    ...
                                    function (a, o) {
                                        var n = a._model,
                                            r = e.splineCurve(
                                                e.previousItem(i.data, o, !0)._model,
                                                n,
                                                e.nextItem(i.data, o, !0)._model,
                                                n.tension,
                                            );
                            ...
                            removeHoverStyle: function (t) {
                                ...
                                ((n.radius = a.radius
                                    ? a.radius
                                    : e.getValueAtIndexOrDefault(i.radius, o, r.radius)),
                        ...
                        e.extend(t.Controller.prototype, {
                                        ...
                                        function (e, o) {
                                            ...
                                            (n.type || (n.type = e.type || this.config.type),
                                                ...
                                                n.controller
                                                    ...
                                                    : ((n.controller = new t.controllers[n.type](
                                                          this,
                                                          o,
                                                      )),
                                                      a.push(n.controller)));
                            ...
                            render: function (i, a) {
                                ...
                                if (
                                    ...
                                    (('undefined' != typeof i && 0 !== i) ||
                                        ('undefined' == typeof i && 0 !== o.duration))
                                ) {
                            ...
                            updateHoverStyle: function (t, e, i) {
                                ...
                                for (o = 0, n = t.length; n > o; ++o)
                                    ((a = t[o]),
                                        a && this.getDatasetMeta(a._datasetIndex).controller[r](a));
                            },
                            eventHandler: function (t) {
                                ...
                                return (
                                    ...
                                    'mouseout' === t.type
                                        ...
                                        : ((i.active = i.getElementsAtEventForMode(t, n.mode)),
                                    ...
                                    ('mouseup' === t.type || 'click' === t.type) &&
                                        (o.onClick && o.onClick.call(i, t, i.active),
                                        i.legend &&
                                            i.legend.handleEvent &&
                                            i.legend.handleEvent(t)),
                                    i.lastActive.length &&
                                        i.updateHoverStyle(i.lastActive, n.mode, !1),
                                    i.active.length &&
                                        n.mode &&
                                        i.updateHoverStyle(i.active, n.mode, !0),
                                    (r.enabled || r.custom) &&
                                        (a.initialize(),
                                    ...
                                    a.pivot(),
                                    i.animating ||
                                        (e.arrayEquals(i.active, i.lastActive) &&
                                            e.arrayEquals(i.tooltipActive, i.lastTooltipActive)) ||
                                        (i.stop(),
                    ...
                    ((t.DatasetController = function (t, e) {
                        ...
                        e.extend(t.DatasetController.prototype, {
                            ...
                            createMetaDataset: function () {
                                ...
                                return (
                                    e && new e({ _chart: t.chart.chart, _datasetIndex: t.index })
                                );
                            },
                            ...
                            removeHoverStyle: function (t, i) {
                                ...
                                ((s.backgroundColor = n.backgroundColor
                                    ? n.backgroundColor
                                    : r(a.backgroundColor, o, i.backgroundColor)),
                            ...
                            setHoverStyle: function (t) {
                                ...
                                ((s.backgroundColor = o.hoverBackgroundColor
                                    ? o.hoverBackgroundColor
                                    : n(i.hoverBackgroundColor, a, r(s.backgroundColor))),
                                    (s.borderColor = o.hoverBorderColor
                                        ? o.hoverBorderColor
                                        : n(i.hoverBorderColor, a, r(s.borderColor))),
                                    (s.borderWidth = o.hoverBorderWidth
                                        ? o.hoverBorderWidth
                                        : n(i.hoverBorderWidth, a, s.borderWidth)));
                            },
                        }),
                ...
                e.exports = function (t) {
                            ...
                            return (
                                n.each(Array.prototype.slice.call(arguments, 1), function (e) {
                                    n.each(e, function (e, a) {
                                        if ('scales' === a)
                                            i[a] = n.scaleMerge(i.hasOwnProperty(a) ? i[a] : {}, e);
                                        else if ('scale' === a)
                                            i[a] = n.configMerge(
                    ...
                    ((n.requestAnimFrame = (function () {
                        ...
                        (n.getRelativePosition = function (t, e) {
                            ...
                            return (
                                (i = Math.round(
                                    (((i - s.left - h) / f) * r.width) / e.currentDevicePixelRatio,
                                )),
                                (a = Math.round(
                                    (((a - s.top - d) / g) * r.height) / e.currentDevicePixelRatio,
                                )),
                                { x: i, y: a }
                            );
                        }),
                        ...
                        (n.retinaScale = function (t) {
                            ...
                            (1 !== n &&
                                ...
                                (i.width = a * n),
                                e.scale(n, n),
                                (t.originalDevicePixelRatio = t.originalDevicePixelRatio || n)),
                                (i.style.width = a + 'px'),
                                (i.style.height = o + 'px'));
                        }),
                        (n.clear = function (t) {
                        ...
                        (n.longestText = function (t, e, i, a) {
                            ...
                            (a.font !== e &&
                                ((o = a.data = {}), (r = a.garbageCollect = []), (a.font = e)),
                                (t.font = e));
                            var s = 0;
                            n.each(i, function (e) {
                                if (void 0 !== e && null !== e) {
                                    var i = o[e];
                                    (i || ((i = o[e] = t.measureText(e).width), r.push(e)),
                                        i > s && (s = i));
                                }
                            });
                            var l = r.length / 2;
                        ...
                        (n.getHoverColor = function (t) {
                            return t instanceof CanvasPattern
                                ? t
                                : n.color(t).saturate(0.5).darken(0.1).rgbString();
                        }));
                };
            },
            { 'chartjs-color': 3 },
                ...
                e.exports = function (t) {
                    ...
                    ((t.defaults.global.legend = {
                        ...
                        onClick: function (t, e) {
                            ...
                            ((o.hidden = null === o.hidden ? !a.data.datasets[i].hidden : null),
                                a.update());
                        },
                        labels: {
                            boxWidth: 40,
                        ...
                        (t.Legend = t.Element.extend({
                            ...
                            fit: function () {
                                ...
                                if (
                                    (g
                                        ? ((f.width = this.maxWidth), (f.height = o ? 10 : 0))
                                        : ((f.width = o ? 10 : 0), (f.height = this.maxHeight)),
                                    o && g)
                                ) {
                                    ...
                                    ((n.textAlign = 'left'),
                                        ...
                                        e.each(
                                            ...
                                            function (t, e) {
                                                ...
                                                (p[p.length - 1] + i + a.padding >= this.width &&
                                                    ((m += l + a.padding),
                                        ...
                                        e.each(
                                            ...
                                            function (t, e) {
                                                ...
                                                (f + c >= r &&
                                                    ...
                                                    l.setLineDash &&
                                                        l.setLineDash(d(t.lineDash, n.borderDash)),
                                ...
                                if (
                                    ...
                                    for (var r = this.legendHitBoxes, s = 0; s < r.length; ++s) {
                                        ...
                                        if (
                                            ...
                                            n.onClick &&
                                                n.onClick.call(this, t, this.legendItems[s]);
                                            break;
                                        }
                                    }
                            },
                        ...
                        (t.Scale = t.Element.extend({
                            ...
                            fit: function () {
                                ...
                                if (
                                    ...
                                    r.display &&
                                        s &&
                                        (l ? (i.height += 1.5 * f) : (i.width += 1.5 * f)),
                                    n.display && s)
                                ) {
                                    this.longestTextCache || (this.longestTextCache = {});
                                    var b = e.longestText(
                                    ...
                                    if (l) {
                                        ...
                                        ((this.paddingLeft =
                                            0 !== this.labelRotation ? k * x + 3 : x / 2 + 3),
                                            (this.paddingRight =
                            ...
                            getBasePixel: function () {
                                ...
                                return t.getPixelForValue(
                                    t.beginAtZero ? 0 : 0 > e && 0 > i ? i : e > 0 && i > 0 ? e : 0,
                                );
                            },
                            draw: function (i) {
                                var a = this.options;
                                if (a.display) {
                                    ...
                                    if (((h.fillStyle = m), this.isHorizontal())) {
                                        ...
                                        if (
                                            ((n = !1),
                                            g && (F /= 2),
                                            (F + c.autoSkipPadding) * this.ticks.length >
                                                this.width -
                                                ...
                                                function (t, r) {
                                                    ...
                                                    if ((!l || s) && void 0 !== t && null !== t) {
                                                        ...
                                                        (u.display &&
                                                            (r ===
                                                            ('undefined' !=
                                                            typeof this.zeroLineIndex
                                                                ? this.zeroLineIndex
                                                                : 0)
                                                                ? ((h.lineWidth = u.zeroLineWidth),
                                                                  (h.strokeStyle = u.zeroLineColor),
                                                                  (o = !0))
                                                                : o &&
                                    ...
                                    if (u.drawBorder) {
                                        ...
                                        (this.isHorizontal()
                                            ? ((L = B =
                                                  'top' === a.position ? this.bottom : this.top),
                                              (L += z),
                                              (B += z))
                                            : ((O = W =
                                                  'left' === a.position ? this.right : this.left),
                                              (O += z),
                                              (W += z)),
                                            h.beginPath(),
                                            h.moveTo(O, L),
                            ...
                            update: function (t) {
                                if (this._active.length) {
                                    ...
                                    if ('single' === this._options.tooltips.mode) {
                                        ...
                                        (n.push({
                                            xLabel: a._xScale
                                                ...
                                                : '',
                                            yLabel: r
                                                ? r.getLabelForIndex(a._index, a._datasetIndex)
                                                : '',
                                            index: a._index,
                                    ...
                                    (this.determineAlignment(s),
                                        i.extend(
                                            this._model,
                                            this.getBackgroundPoint(this._model, s),
                                        ));
                                    ...
                                    e(this._model.x)
                                        ? ((this._model.xAlign = 'left'),
                                          a(this._model.x) &&
                                              ...
                                              (this._model.yAlign = n(this._model.y))))
                                        : i(this._model.x) &&
                                    ...
                                    i.each(
                                        ...
                                        function (n, r) {
                                            ('single' !== this._options.tooltips.mode &&
                                                ...
                                                (a.strokeStyle = i
                                                    .color(e.labelColors[r].borderColor)
                                                    .alpha(o)
                                                    .rgbaString()),
                                                a.strokeRect(
                                                    t.x,
                                                ...
                                                (a.fillStyle = i
                                                    .color(e.labelColors[r].backgroundColor)
                                                    .alpha(o)
                                                    .rgbaString()),
                                                a.fillRect(
                                                    t.x + 1,
                                    ...
                                    this._children.length > 0 &&
                                        ...
                                        e.each(
                                            ...
                                            function (t, i) {
                                                ...
                                                0 === i
                                                    ? (this._loop
                                                          ? n.moveTo(o.scaleZero.x, o.scaleZero.y)
                                                          : n.moveTo(t._view.x, o.scaleZero),
                                                      t._view.skip
                                                          ? this._loop ||
                                                            n.moveTo(
                                                                r._view.x,
                        ...
                        a = t.Scale.extend({
                            ...
                            getPixelForValue: function (t, e, i, a) {
                                ...
                                if (this.isHorizontal()) {
                                    ...
                                    return (
                                        this.options.gridLines.offsetGridLines && a && (s += r / 2),
                                ...
                                return (
                                    this.options.gridLines.offsetGridLines && a && (d += h / 2),
                                    ...
                                    (e.each(s, function (o, r) {
                                        ...
                                        e.each(h, function (t) {
                                            var a = t.positiveValues.concat(t.negativeValues),
                                                o = e.min(a),
                                                n = e.max(a);
                                            ((i.min = null === i.min ? o : Math.min(i.min, o)),
                                                (i.max = null === i.max ? n : Math.max(i.max, n)));
                                        }));
                                } else
                                ...
                                (void 0 !== o.min
                                    ...
                                    void 0 !== o.max
                                        ...
                                        : void 0 !== o.suggestedMax &&
                                          (i.max = Math.max(i.max, o.suggestedMax)),
                                        ...
                                        n.isDatasetVisible(r) &&
                                            ...
                                            e.each(o.data, function (t, e) {
                                                ...
                                                isNaN(n) ||
                                                    s.data[e].hidden ||
                                                    ((o[e] = o[e] || 0),
                                                    a.relativePoints ? (o[e] = 100) : (o[e] += n));
                                            }));
                                    }),
                                        e.each(d, function (t) {
                                            var a = e.min(t),
                            ...
                            getPixelForValue: function (t, i, a, o) {
                                ...
                                return (
                                    s.isHorizontal()
                                        ? 0 === h
                                            ? (r = s.left + f)
                                            : ((n = s.width - (f + s.paddingRight)),
                                              (r = s.left + (n / d) * (e.log10(h) - e.log10(l))),
                                              (r += f))
                                        : 0 === h
                                          ? (r = s.top + c)
                                          : ((n = s.height - (c + u)),
                                ...
                                return (
                                    o.isHorizontal()
                                        ? ((a = o.width - (o.paddingLeft + o.paddingRight)),
                                          (i =
                                              o.start *
                                              Math.pow(10, ((t - o.left - o.paddingLeft) * n) / a)))
                                        : ((a = o.height - (o.paddingTop + o.paddingBottom)),
                                          (i =
                                              Math.pow(
                                                  10,
                                                  ((o.bottom - o.paddingBottom - t) * n) / a,
                                              ) / o.start)),
                                    i
                                );
                            },
                        ...
                        o = t.Scale.extend({
                            ...
                            buildTicks: function () {
                                ...
                                var o = e.niceNum(this.max - this.min, !1),
                                    ...
                                    l = Math.ceil((s - r) / n);
                                this.ticks.push(
                                    void 0 !== this.options.ticks.min ? this.options.ticks.min : r,
                                );
                                for (var h = 1; l > h; ++h) this.ticks.push(r + h * n);
                                (this.ticks.push(
                                    void 0 !== this.options.ticks.max ? this.options.ticks.max : s,
                                ),
                                ...
                                buildTicks: function (a) {
                                    ...
                                    if (
                                        ...
                                        for (var g = 0, p = i.units[g]; g < i.units.length;) {
                                            ...
                                            if (
                                                p.maxStep === !1 ||
                                                Math.ceil(this.scaleSizeInUnits / f) < p.maxStep
                                            ) {
                                                this.unitScale = e.getValueOrDefault(
                                                    this.options.time.unitStepSize,
                                                    Math.ceil(this.scaleSizeInUnits / f),
                                    ...
                                    if (o) {
                                        ...
                                        if (this.isHorizontal()) {
                                            var s =
                                                    ...
                                                    (this.paddingLeft + this.paddingRight),
                                                l =
                                                    (s / Math.max(this.ticks.length - 1, 1),
                                        ...
                                        var h =
                                                ...
                                                (this.paddingTop + this.paddingBottom),
                                            d =
                                                (h / Math.max(this.ticks.length - 1, 1),
                                                h * r + this.paddingTop);
                                ...
                                getValueForPixel: function (t) {
                                    ...
                                    return (
                                        ...
                                        this.firstTick
                                            .clone()
                                            .add(
                                                a.duration(i, this.tickUnit).asSeconds(),
                                                'seconds',
                                            )
                                    );
                                },
