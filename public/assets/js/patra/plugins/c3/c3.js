(function (window) {
    ...
    c3_chart_internal_fn.initParams = function () {
        ...
        $$.isLegendTop =
            config.legend_inset_anchor === 'top-left' || config.legend_inset_anchor === 'top-right';
        $$.isLegendLeft =
    ...
    c3_chart_internal_fn.updateSizes = function () {
        ...
        var legendHeight = $$.legend ? $$.getLegendHeight() : 0,
            ...
            subchartHeight =
                config.subchart_show && !hasArc ? config.subchart_size_height + xAxisHeight : 0;
    ...
    c3_chart_internal_fn.updateXDomain = function (
        ...
        if (withUpdateXDomain) {
            $$.x.domain(
                domain ? domain : !$$.brush || $$.brush.empty() ? $$.orgXDomain : $$.brush.extent(),
            );
            if (config.zoom_enabled) {
                $$.zoom.scale($$.x).updateScaleExtent();
            }
    ...
    c3_chart_internal_fn.redrawEventRect = function () {
        ...
        var eventRects = $$.main
            ...
            .style(
                'cursor',
                config.zoom_enabled ? (config.axis_rotated ? 'ns-resize' : 'ew-resize') : null,
            )
    ...
    c3_chart_internal_fn.lineWithRegions = function (d, x, y, _regions) {
        ...
        function generateM(points) {
            return (
                'M' + points[0][0] + ' ' + points[0][1] + ' ' + points[1][0] + ' ' + points[1][1]
            );
        }
        if ($$.isTimeSeries()) {
    ...
    c3_chart_internal_fn.getCircles = function (i, id) {
        var $$ = this;
        return (
            id ? $$.main.selectAll('.' + CLASS.circles + $$.getTargetSelectorSuffix(id)) : $$.main
    ...
    c3_chart_internal_fn.getBars = function (i, id) {
        var $$ = this;
        return (
            id ? $$.main.selectAll('.' + CLASS.bars + $$.getTargetSelectorSuffix(id)) : $$.main
    ...
    c3_chart_internal_fn.updateRadius = function () {
        ...
        $$.innerRadius =
            $$.hasType('donut') || $$.hasType('gauge') ? $$.radius * $$.innerRadiusRatio : 0;
    };
    ...
    c3_chart_internal_fn.transformForArcLabel = function (d) {
        ...
        if (updated && !$$.hasType('gauge')) {
            ...
            ratio =
                $$.radius && h
                    ? ((36 / $$.radius > 0.375 ? 1.175 - 36 / $$.radius : 0.8) * $$.radius) / h
                    : 0;
            ...
            if (!config.data_selection_multiple) {
                $$.main
                    .selectAll(
                        '.' +
                            CLASS.shapes +
                            (config.data_selection_grouped ? $$.getTargetSelectorSuffix(d.id) : ''),
                    )
                    .selectAll('.' + CLASS.shape)
                    .each(function (d, i) {
                        var shape = d3.select(this);
        ...
        return function () {
            ...
            d3.transition()
                ...
                .each(function () {
                    ...
                    wait.add(
                        mainRegion.filter($$.isRegionOnX).transition().attr('transform', transform),
                    );
        ...
        function axis(g) {
            g.each(function () {
                ...
                var range = scale.rangeExtent ? scale.rangeExtent() : scaleExtent(scale.range()),
                    ...
                    pathUpdate =
                        (path.enter().append('path').attr('class', 'domain'), transitionise(path));
