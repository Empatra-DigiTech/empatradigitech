...
(!(function (a) {
                ...
                if (
                    ...
                    switch (
                        (void 0 === this.options.value || null === this.options.value
                            ? ((this.value = this.input.html2value(a.trim(this.$element.html()))),
                              (c = !0))
                ...
                str2value: function (b) {
                    ...
                    return (
                        'string' == typeof b && b.length
                            ? ((c = new RegExp('\\s*' + a.trim(this.options.separator) + '\\s*')),
                              (d = b.split(c)))
                            : (d = a.isArray(b) ? b : [b]),
                        d
                    );
            ...
            a.extend(b.prototype, {
                ...
                value2html: function (c, d) {
                    ...
                    (this.options.select2.tags
                        ? (e = c)
                        : this.sourceData &&
                          (e = a.fn.editableutils.itemsByValue(c, this.sourceData, this.idFunc)),
                        a.isArray(e)
                            ? ((f = []),
    ...
    (function (a) {
        ...
        e.prototype = {
            ...
            showMode: function (a) {
                (a &&
                    (this.viewMode = Math.max(this.o.minViewMode, Math.min(2, this.viewMode + a))),
                    this.picker
                        .find('>div')
                        .hide()
        ...
        var k = (a.fn.datepicker.dates = {
            ...
            l = {
                ...
                getDaysInMonth: function (a, b) {
                    return [31, l.isLeapYear(a) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][
                        b
                    ];
                },
                ...
                formatDate: function (b, c, d) {
                    ...
                    for (
                        var b = [], f = a.extend([], c.separators), g = 0, h = c.parts.length;
                        h >= g;
                        g++
                    )
