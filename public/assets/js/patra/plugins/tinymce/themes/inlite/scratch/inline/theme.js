...
jsc*/
     ...
     */
    define('o', ['s', 'b', 't', 'u'], function (Bookmark, Tools, TreeWalker, RangeUtils) {
    ...
    define('f', ['b', 'c', 'm', 'k', 'p'], function (Tools, Factory, Promise, Actions, UrlType) {
    ...
    define('4', ['3', 'i', 'j', 'k'], function (Panel, Conversions, Picker, Actions) {
