...
(function (g) {
    ...
    var u = 0,
        p = (function () {
            var a = t.userAgent,
                b = /msie\s\d+/i;
            return 0 < a.search(b) && ((a = b.exec(a).toString()), (a = a.split(' ')[1]), 9 > a)
    ...
    r.prototype = {
        ...
        pointerMove: function (a) {
            this.dragging &&
                ((this.coords.x_pointer =
                    (a.pageX || (a.originalEvent.touches && a.originalEvent.touches[0].pageX)) -
                    this.coords.x_gap),
                this.calc());
        },
        ...
        convertToValue: function (a) {
            ...
            (b = this.options.step.toString().split('.')[1])
                ...
                : ((a /= this.options.step), (a *= this.options.step), (a = +a.toFixed(0)));
            k && (a -= k);
