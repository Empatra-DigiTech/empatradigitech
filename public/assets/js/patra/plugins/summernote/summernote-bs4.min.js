    ...
    var j =
        ...
        o = (function () {
            var b = function (b) {
                ...
                g = function (a) {
                    return (
                        a && /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(a.nodeName.toUpperCase())
                    );
                },
                h = function (a) {
        ...
        E = r.create('<div class="note-color-palette"/>', function (a, b) {
            ...
            (a.html(c.join('')),
                b.tooltip &&
                    a
                        .find('.note-color-btn')
                        .tooltip({ container: 'body', trigger: 'hover', placement: 'bottom' }));
        }),
                        ...
                        (this.scrollIntoView = function (b) {
                            ...
                            return (
                                b.scrollTop + c < this.sc.offsetTop &&
                                    (b.scrollTop += Math.abs(b.scrollTop + c - this.sc.offsetTop)),
                                this
                            );
                        }),
                            ...
                            var a = function (a, b) {
                                    ...
                                    return (
                                        (b
                                            ...
                                            : o.prevPointUntil(o.prevPoint(a), o.isVisiblePoint)) ||
                                        a
                                    );
                                },
        ...
        U = function (b) {
            ...
            ((this.tab = function () {
                ...
                (this.getSelectedText = function () {
                    var a = this.createRange();
                    return (
                        a.isOnAnchor() && (a = L.createFromNode(o.ancestor(a.sc, o.isAnchor))),
                        a.toString()
                    );
                }),
            ...
            ((this.events = {
                ...
                (this.pasteByHook = function () {
                    ...
                    if (o.isImg(c) && 0 === d.indexOf('data:')) {
                        for (
                            var e = atob(c.src.split(',')[1]), f = new Uint8Array(e.length), g = 0;
                            g < e.length;
                            g++
                        )
                            f[g] = e.charCodeAt(g);
                                    ...
                                    ],
                                    {
                                        callback: function (a) {
                                            a.find('.note-dimension-picker-mousecatcher')
                                                ...
                                                .mousedown(
                                                    b.createInvokeHandler('editor.insertTable'),
                                                )
        ...
        la = function (b) {
            ...
            ((this.events = {
                ...
                'summernote.focusout': function (a, b) {
                    k.isFF ||
                        (b.relatedTarget && o.ancestor(b.relatedTarget, l.eq(c.$popover[0]))) ||
                        c.hide();
                },
            }),
                (this.shouldInitialize = function () {
