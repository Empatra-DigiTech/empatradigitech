(function (g) {
    ...
    function E(a, b) {
        v === m &&
            (v =
                -1 ===
                y.serializeToString(g.parseXML(F['xl/worksheets/sheet1.xml'])).indexOf('xmlns:r'));
    ...
    var p;
    var h =
        ('undefined' !== typeof self && self) || ('undefined' !== typeof j && j) || this.content;
    ...
    s.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            c.message &&
                a.content.unshift({ text: c.message, style: 'message', margin: [0, 0, 0, 12] });
            c.title &&
                a.content.unshift({ text: R(c, false), style: 'title', margin: [0, 0, 0, 12] });
