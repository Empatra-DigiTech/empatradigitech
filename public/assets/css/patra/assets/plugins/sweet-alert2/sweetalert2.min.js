(!(function (e, t) {
    ...
    l.length
        ? (a = l[0])
        : ((a = document.createElement('div')), (a.className = n.container), (a.innerHTML = i));
    var s = function (e, t) {
        ...
        _ = function (e) {
            ...
            var b = g(),
                S = parseInt(
                    null === e.currentProgressStep ? F.getQueueStep() : e.currentProgressStep,
                    10,
                );
        ...
        $ = function () {
            ...
            return new Promise(function (e, t) {
                ...
                ((c.previousWindowKeyDown = window.onkeydown),
                    ...
                    F.resetValidationError());
                for (
                    var V = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
                        O = void 0,
                        N = 0;
                    N < V.length;
                    N++
    ...
    return (
        ...
        (F.setDefaults = function (e) {
            ...
            for (var t in e)
                r.hasOwnProperty(t) ||
                    'extraParams' === t ||
                    (console.warn('SweetAlert2: Unknown parameter "' + t + '"'), delete e[t]);
            W(U, e);
        }),
