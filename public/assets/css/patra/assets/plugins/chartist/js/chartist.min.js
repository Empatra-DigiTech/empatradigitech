        ...
        (function (a, b, c) {
            ...
            ((c.namespaces = {
                ...
                (c.getBounds = function (a, b, d, e) {
                    ...
                    var n = 2.221e-16;
                    for (j.step = Math.max(j.step, n), g = j.min, h = j.max; g + j.step <= j.low;)
                        g += j.step;
                ...
                (c.createGrid = function (a, b, d, e, f, g, h, i) {
                    ...
                    i.emit(
                        'draw',
                        c.extend({ type: 'grid', axis: d, index: b, group: g, element: k }, j),
                    );
                }),
                (c.createLabel = function (a, b, d, e, f, g, h, i, j, k, l) {
                    ...
                    l.emit(
                        'draw',
                        c.extend(
                            { type: 'label', axis: f, index: d, group: i, element: m, text: e[d] },
                            n,
                        ),
                    );
                }),
                ...
                ((d =
                    void 0 === a.axisX.type
                        ? new c.StepAxis(
                              ...
                              b,
                              j,
                              c.extend({}, a.axisX, { ticks: b.raw.labels, stretch: a.fullWidth }),
                          )
