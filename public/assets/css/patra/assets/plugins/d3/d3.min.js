!(function () {
    ...
    function r(n) {
        return {
            left: function (t, e, r, u) {
                for (
                    arguments.length < 3 && (r = 0), arguments.length < 4 && (u = t.length);
                    u > r;
                ) {
                    var i = (r + u) >>> 1;
                    n(t[i], e) < 0 ? (r = i + 1) : (u = i);
    ...
    function L(n) {
        ...
        return function (e, r) {
            ...
            r
                ? ((t.lastIndex = 0), t.test(u) || e.setAttribute('class', N(u + ' ' + n)))
    ...
    function B(n, t) {
        ...
        if (e.createSVGPoint) {
            ...
            return (
                La ? ((r.x = t.pageX), (r.y = t.pageY)) : ((r.x = t.clientX), (r.y = t.clientY)),
    ...
    function ke() {
        function n(n, u) {
            ...
            var i = Math.cos((u *= Fa)),
                ...
                l = Math.atan2(
                    Math.sqrt(
                        (l = e * c - r * a) * l + (l = r * o - t * c) * l + (l = t * a - e * o) * l,
                    ),
                    t * o + e * a + r * c,
                );
            ((kc += l),
            ...
            function h() {
                ...
                if ((v.pop(), p.push(v), (v = null), r))
                    if (1 & t) {
                        ...
                        (r > 1 && 2 & t && e.push(e.pop().concat(e.shift())), g.push(e.filter(Re)));
            }
            var g,
                p,
                v,
    ...
    function or(n) {
        ...
        return (
            ...
            (t.clipExtent = function (n) {
                return arguments.length
                    ? ((w = n), (b = n ? Ie(n[0][0], n[0][1], n[1][0], n[1][1]) : At), u())
                    : w;
            }),
            (t.scale = function (n) {
    ...
    function pr(n, t) {
        ...
        return function (u, i, o, a) {
            var c = o * t;
            null != u
                ? ((u = vr(e, u)), (i = vr(e, i)), (o > 0 ? i > u : u > i) && (u += o * Pa))
                : ((u = n + o * Pa), (i = n - 0.5 * c));
    ...
    function Br(n) {
        for (var t, e = tl, r = Ye(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;)
            ((t = e[u]),
                (!Wr(t, n) || !r(t) || (va(t.a.x - t.b.x) < Ta && va(t.a.y - t.b.y) < Ta)) &&
    ...
    function ou(n, t) {
        ...
        for (tl = [], el = new Array(n.length), rl = new tu(), il = new tu(); ;)
            if (((u = ul), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
                ((i.x !== e || i.y !== r) && ((el[i.i] = new Yr(i)), Fr(i), (e = i.x), (r = i.y)),
                    (i = n.pop()));
            else {
                if (!u) break;
                jr(u.arc);
    ...
    function zu(n, t) {
        ...
        return (
            ...
            arguments.length ? (e = (t / Pa) * Math.asin(1 / n)) : ((n = 1), (e = t / 4)),
            function (r) {
    ...
    function Uu(n) {
        ...
        (t[0] * e[1] < e[0] * t[1] && ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
            (this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ha),
        ...
        return (
            ...
            l != s
                ? (l - s > 180 ? (s += 360) : s - l > 180 && (l += 360),
                  u.push({ i: r.push(r.pop() + 'rotate(', null, ')') - 2, x: du(l, s) }))
            ...
            g[0] != p[0] || g[1] != p[1]
                ? ((e = r.push(r.pop() + 'scale(', null, ',', null, ')')),
                  u.push({ i: e - 4, x: du(g[0], p[0]) }, { i: e - 2, x: du(g[1], p[1]) }))
    ...
    function Xu(n, t) {
        if (n === t) return n;
        for (var e = Vu(n), r = Vu(t), u = e.pop(), i = r.pop(), o = null; u === i;)
            ((o = u), (u = e.pop()), (i = r.pop()));
        return o;
    }
    function $u(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            if (
                ...
                for (
                    ...
                    p
                        ? (d > v || (v == d && u.r < r.r) ? yi(r, (u = a)) : yi((r = c), u), o--)
                        : (mi(r, i), (u = i), t(i));
                }
            var m = (s + f) / 2,
                y = (h + g) / 2,
    ...
    function no(n, t) {
        function e(e) {
            return i[
                ((u.get(e) || ('range' === t.t ? u.set(e, n.push(e)) : 0 / 0)) - 1) % i.length
            ];
        }
        function r(t, e) {
    ...
    function go(n) {
        ...
        return (
            ...
            (t.interpolate = function (n) {
                return arguments.length
                    ? ((o = 'function' == typeof n ? (i = n) : (i = zl.get(n) || po).key), t)
                    : o;
            }),
    ...
    function bo(n, t) {
        return n.length < 3
            ? po(n)
            : n[0] + wo((n.push(n[0]), n), So([n[n.length - 2]].concat(n, [n[1]]), t));
    }
    function _o(n, t) {
    ...
    function Ao(n) {
        ...
        for (t = [Co(Tl, o), ',', Co(Tl, a)], --r; ++r < i;)
            ((e = n[r % u]), o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), zo(t, o, a));
        return t.join('');
    }
    function No(n, t) {
        var e = n.length - 1;
        if (e)
            for (
                var r, u, i = n[0][0], o = n[0][1], a = n[e][0] - i, c = n[e][1] - o, l = -1;
                ++l <= e;
            )
                ((r = n[l]),
                    (u = l / e),
    ...
    function Lo(n) {
        for (
            var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = (r[0] = qo(u, i));
            ++t < e;
        )
    ...
    ((ta.ascending = n),
        ...
        (ta.mean = function (n, r) {
            var u,
                ...
                a = -1,
                c = o;
            if (1 === arguments.length) for (; ++a < o;) e((u = t(n[a]))) ? (i += u) : --c;
        ...
        (ta.median = function (r, u) {
            var i,
                ...
                a = r.length,
                c = -1;
            if (1 === arguments.length) for (; ++c < a;) e((i = t(r[c]))) && o.push(i);
    ...
    ((ta.range = function (n, t, e) {
        ...
        var r,
            ...
            o = i(va(e)),
            a = -1;
        if (((n *= o), (t *= o), (e *= o), 0 > e)) for (; (r = n + e * ++a) > t;) u.push(r / o);
            ...
            if (arguments.length < 2) {
                if ('string' == typeof n) {
                    ...
                    if ((t = e.classList)) {
                        ...
                        for (t = e.getAttribute('class'); ++u < r;) if (!C(n[u]).test(t)) return !1;
                    return !0;
                }
    ...
    ((ta.interpolateZoom = function (n, t) {
        ...
        (ta.behavior.zoom = function () {
            ...
            function f() {
                ...
                function e() {
                    ...
                    if (1 === a.length) {
                        if (500 > c - y) {
                            var l = a[0];
                            (i(p, l, d[l.identifier], Math.floor(Math.log(k.k) / Math.LN2) + 1),
                                b());
                        }
                        y = c;
                    } else if (a.length > 1) {
            ...
            function h() {
                ...
                (m ? clearTimeout(m) : ((p = t((v = d || ta.mouse(this)))), I(this), a(n)),
    ...
    var jc,
        ...
        Vc = { point: $e, lineStart: y, lineEnd: y, polygonStart: y, polygonEnd: y },
        Xc = {
            point: Je,
            lineStart: Ge,
            lineEnd: Ke,
    ...
    var $c,
        Bc = { sphere: y, point: y, lineStart: br, lineEnd: y, polygonStart: y, polygonEnd: y },
        Wc = _r(
            function (n) {
        ...
        (tu.prototype = {
            insert: function (n, t) {
                ...
                if (n) {
                    ...
                    this._
                        ? ((n = iu(this._)), (t.P = null), (t.N = n), (n.P = n.L = t), (e = n))
                    ...
                    return arguments.length
                        ? ((n = +n),
                          r
                              ? (r = n > 0 ? n : 0)
                              : n > 0 &&
                                (c.start({ type: 'start', alpha: (r = n) }), ta.timer(a.tick)),
                          a)
                        : r;
                }),
                (a.start = function () {
                    ...
                    return (
                        e ||
                            (e = ta.behavior
                                ...
                                .on('dragend.force', Bu)),
                        arguments.length
                            ? (this.on('mouseover.force', Wu).on('mouseout.force', Ju).call(e),
                              void 0)
                            : e
                    );
                }),
            ...
            function n() {
                ...
                if (
                    ((m = (+c.apply(this, arguments) || 0) / 2) &&
                        ((d = i === Cl ? Math.sqrt(n * n + l * l) : +i.apply(this, arguments)),
                        g || (A *= -1),
                    ...
                    if (
                        ('bottom' === r || 'top' === r
                            ? ((n = Bo),
                              ...
                              (w = 'x2'),
                              (k = 'y2'),
                              N.attr('dy', 0 > q ? '0em' : '.71em').style('text-anchor', 'middle'),
                              b.attr('d', 'M' + M[0] + ',' + q * i + 'V0H' + M[1] + 'V' + q * i))
                            : ((n = Wo),
                              (_ = 'y'),
                              (S = 'x'),
                              (w = 'y2'),
                              (k = 'x2'),
                              N.attr('dy', '.32em').style('text-anchor', 0 > q ? 'end' : 'start'),
                              b.attr('d', 'M' + q * i + ',' + M[0] + 'H0V' + M[1] + 'H' + q * i)),
                        E.attr(k, q * u),
                        C.attr(S, q * y),
        ...
        function n(i) {
            i.each(function () {
                ...
                (c && ((s = ji(c)), h.attr('x', s[0]).attr('width', s[1] - s[0]), e(f)),
                    l && ((s = ji(l)), h.attr('y', s[0]).attr('height', s[1] - s[0]), r(f)),
                    t(f));
            });
        }
        function t(n) {
    ...
    var Il = {
        ...
        Zl = [['n', 'e', 's', 'w', 'nw', 'ne', 'se', 'sw'], ['e', 'w'], ['n', 's'], []],
        Vl = (fc.format = mc.timeFormat),
        Xl = Vl.utc,
        $l = Xl('%Y-%m-%dT%H:%M:%S.%LZ');
    ((Vl.iso = Date.prototype.toISOString && +new Date('2000-01-01T00:00:00.000Z') ? Jo : $l),
        (Jo.parse = function (n) {
            var t = new Date(n);
