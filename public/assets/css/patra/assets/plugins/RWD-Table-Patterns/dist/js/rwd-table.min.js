...
!(function (a) {
    ...
    ((f.DEFAULTS = {
        ...
        (f.prototype.createButtonToolbar = function () {
            var b = this;
            ((this.$btnToolbar = a('[data-responsive-table-toolbar="' + this.id + '"]').addClass(
                'btn-toolbar',
            )),
            ...
            if (
                ...
                if (
                    ...
                    this.options.mainContainer === window && e - d > f
                        ? ((c -= e - d - f), b.$stickyTableHeader.addClass('border-radius-fix'))
                        : this.options.mainContainer !== window && -d > f
                          ? ((c -= -d - f), b.$stickyTableHeader.addClass('border-radius-fix'))
                                ...
                                (b.$table.hasClass('display-all') &&
                                    ...
                                    e.each(function () {
                                        ...
                                        if (c.is(':checked')) {
                                            ...
                                            !b.closest('thead').length &&
                                            parseInt(b.prop('colSpan')) > 1
                                                ? b.prop('colSpan', parseInt(b.prop('colSpan')) - 1)
                                                : b.hide();
                                    }));
                            })
        ...
        (f.prototype.buildHeaderCellIndices = function () {
            ...
            if (
                (this.$thead
                    ...
                    .each(function (f) {
                        for (
                            var g = a(this), h = g.prop('colSpan'), i = g.prop('rowSpan'), j = 0;
                            j < h;
                            j++
                        )
        ...
        (f.prototype.update = function () {
            ...
            var b = this.$table.find('tbody, tfoot').clone();
            (b.find('[id]').each(function () {
                a(this).prop('id', a(this).prop('id') + '-clone');
            }),
                b.appendTo(this.$tableClone),
    ...
    ((a.fn.responsiveTable = function (b) {
        ...
        a(document).on('ready.responsive-table.data-api', function () {
            a('.table-responsive[data-pattern]').each(function () {
                var b = a(this);
