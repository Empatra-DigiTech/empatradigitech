    ...
    b.prototype = {
        ...
        toHex: function (a, b, c, d) {
            ...
            return this.rgbaIsTransparent(e)
                ? 'transparent'
                : '#' +
                      ((1 << 24) | (parseInt(e.r) << 16) | (parseInt(e.g) << 8) | parseInt(e.b))
                          .toString(16)
                          .substr(1);
        },
    ...
    var c = {
        ...
        d = function (d, e) {
            if (
                ...
                (this.container =
                    this.options.container === !0 ? this.element : this.options.container),
                ...
                (this.format =
                    this.options.format !== !1 ? this.options.format : this.color.origFormat),
                ...
                ('rgba' !== this.format && 'hsla' !== this.format && this.options.format !== !1) ||
                    this.picker.addClass('colorpicker-with-alpha'),
                'right' === this.options.align && this.picker.addClass('colorpicker-right'),
                this.options.inline === !0 && this.picker.addClass('colorpicker-no-arrow'),
                this.options.colorSelectors)
            ) {
                var f = this;
