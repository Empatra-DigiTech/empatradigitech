!(function (t) {
    ...
    function h(t, n, e, a, o, r, l) {
        ...
        for (
            ...
            ((h = (n + s / 4) % 1),
                (c = Math.floor(e + ((s - 1.5) / 1.5) * (1 === s || 2 === s ? -1 : 1) * v) + 0.5),
                (u = a + h * o),
    ...
    function f(t, n, i, e, a, o, r, l, s) {
        ...
        if (
            ...
            if (
                ...
                for (
                    g *= d.length / 2 - 1, c = Math.floor(g), g -= c, c *= 2, c += 2, f = h;
                    f !== c;
                    f += 2
                )
    ...
    var g = 500,
        ...
        C = [
            ...
            [
                -0.75, 0, -0.7033, 0.0195, -0.6569, 0.0399, -0.6104, 0.06, -0.5634, 0.0789, -0.5155,
                0.0954, -0.4667, 0.1089, -0.4174, 0.1206, -0.3676, 0.1299, -0.3174, 0.1365, -0.2669,
                0.1398, -0.2162, 0.1391, -0.1658, 0.1347, -0.1157, 0.1271, -0.0661, 0.1169, -0.017,
                0.1046, 0.0316, 0.0903, 0.0791, 0.0728, 0.1259, 0.0534, 0.1723, 0.0331, 0.2188,
                0.0129, 0.2656, -0.0064, 0.3122, -0.0263, 0.3586, -0.0466, 0.4052, -0.0665, 0.4525,
                -0.0847, 0.5007, -0.1002, 0.5497, -0.113, 0.5991, -0.124, 0.6491, -0.1325, 0.6994,
                -0.138, 0.75, -0.14,
            ],
        ],
        y = [
        ...
        (b.prototype = {
            _determineDrawingFunction: function (t) {
                return 'string' == typeof t
                    ? ((t = t.toUpperCase().replace(/-/g, '_')), b.hasOwnProperty(t) ? b[t] : null)
                    : void 0;
            },
            add: function (t, n) {
                var i;
            ...
            set: function (t, n) {
                var i;
                for (
                    'string' == typeof t && (t = document.getElementById(t)), i = this.list.length;
                    i--;
                )
            ...
            remove: function (t) {
                var n;
                for (
                    'string' == typeof t && (t = document.getElementById(t)), n = this.list.length;
                    n--;
                )
