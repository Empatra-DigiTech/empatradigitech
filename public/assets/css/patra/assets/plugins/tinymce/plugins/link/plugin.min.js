    ...
    function d(b) {
            ...
            return (
                ...
                c.length
                    ? (c.unshift({ text: 'None', value: '' }),
                      { name: 'anchor', type: 'listbox', label: 'Anchors', values: c, onselect: d })
                    : void 0
            );
        }
        function f() {
        ...
        ((i = v.getNode()),
            ...
            j
                ...
                : a.settings.default_link_target && (u.target = a.settings.default_link_target),
            ...
            a.settings.link_title !== !1 &&
                (s = { name: 'title', type: 'textbox', label: 'Title', value: u.title }),
