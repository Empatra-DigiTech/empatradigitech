...
(function (h) {
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) ((a.scrollBarVis = L), Z(a));
            ...
            if ('' === c) {
                ...
                if (
                    U &&
                    (o.find('tbody').height() > j.offsetHeight || 'scroll' == l.css('overflow-y'))
                )
    ...
    function Ha(a) {
        ...
        if (d || (!r && !f && !e && j == ba(a) && j == n.length))
            ...
            for (m = 0; m < i.length; m++)
                ((p = c[i[m]]),
                    (n[m].style.width =
                        null !== p.sWidthOrig && '' !== p.sWidthOrig ? v(p.sWidthOrig) : ''),
                    p.sWidthOrig &&
                        f &&
                        h(n[m]).append(
                            h('<div/>').css({
    ...
    function Kb(a) {
        for (
            var b, c, d = a.aoColumns, e = W(a), a = a.oLanguage.oAria, f = 0, g = d.length;
            f < g;
            f++
        ) {
            c = d[f];
