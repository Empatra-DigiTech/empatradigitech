                ...
                timeboxparent
                    .on('scroll_element.xdsoft_scroller', function (event, percentage) {
                        ...
                        timeboxTop = parseFloat(
                            Math.abs((timebox[0].offsetHeight - parentHeight) * percentage).toFixed(
                                4,
                            ),
                        );
        ...
        createDateTimePicker = function (input) {
            ...
            datetimepicker.setOptions = function (_options) {
                ...
                if (
                    ...
                    Object.prototype.toString.call(_options.allowDateRe) === '[object String]'
                ) {
                        ...
                        if (
                            ...
                            (!$.trim($(this).val()).length ||
                                (typeof options.mask === 'string' &&
                                    $.trim($(this).val()) === options.mask.replace(/[0-9]/g, '_')))
                        ) {
                            $(this).val(null);
            ...
            XDSoft_datetime = function () {
                ...
                _this.strToDateTime = function (sDateTime) {
                    ...
                    if (tmpDate && tmpDate[2]) {
                        ...
                        currentTime = new Date(
                            _this.now(true).getTime() + parseInt(tmpDate[1] + '1', 10) * timeOffset,
                        );
                    } else {
                ...
                _this.str = function () {
                    ...
                    if (options.yearOffset) {
                        ...
                        format = format.replace(
                            'y',
                            String(_this.currentTime.getFullYear() + options.yearOffset).substring(
                                2,
                                4,
                            ),
                        );
                ...
                .on('afterOpen.xdsoft', function () {
                    if (options.timepicker) {
                        ...
                        if (classType) {
                            ...
                            height = timebox[0].offsetHeight;
                            top =
                                timebox.find(classType).index() * options.timeHeightInTimePicker +
                                1;
            ...
            setPos = function () {
                ...
                if (
                    options.ownerDocument.documentElement.clientWidth - dateInputOffset.left <
