            ...
            m.each(function () {
                function m(a, c) {
                    ...
                    return '[object Array]' === Object.prototype.toString.call(i)
                        ? i
                        : ((!c || 0 >= c) &&
                              (c = X ? 95 : b.isCategory ? Math.ceil(F(G[1]) - F(G[0])) - 12 : 110),
                          d(j, i + ''));
                }
                function n(a, b) {
                    var c = U.h;
                ...
                var O = I.select('line'),
                    ...
                    R = K.select('text');
                b.isCategory
                    ? ((u = Math.ceil((F(1) - F(0)) / 2)), (B = o ? 0 : u), (C = o ? u : 0))
                    : (u = B = 0);
                var S,
                    T,
                    U = i(D.select('.tick')),
        ...
        return (
            ...
            (k.orient = function (a) {
                return arguments.length
                    ? ((q = a in { top: 1, right: 1, bottom: 1, left: 1 } ? a + '' : 'bottom'), k)
                    : q;
            }),
    ...
    ((k.generate = function (a) {
        ...
        (i.initParams = function () {
            ...
            ((a.clipId = 'c3-' + +new Date() + '-clip'),
                ...
                (a.isLegendTop =
                    'top-left' === c.legend_inset_anchor || 'top-right' === c.legend_inset_anchor),
                (a.isLegendLeft =
            ...
            return (
                ...
                0 === s.length
                    ...
                    : (isNaN(x) && (x = 0),
                      ...
                      (f = g = h = 0.1 * e),
                      'undefined' != typeof z &&
                          ((i = Math.max(Math.abs(x), Math.abs(y))), (y = z + i), (x = z - i)),
                      C
        ...
        (i.getXDomain = function (a) {
            ...
            return (
                ...
                (e || 0 === e) &&
                    (h = b.isTimeSeries() ? new Date(e.getTime() + f.right) : e + f.right),
                [g, h]
            );
        }),
        (i.updateXDomain = function (a, b, c, d, e) {
            ...
            return (
                ...
                b &&
                    (f.x.domain(
                        e ? e : !f.brush || f.brush.empty() ? f.orgXDomain : f.brush.extent(),
                    ),
                    g.zoom_enabled && f.zoom.scale(f.x).updateScaleExtent()),
        ...
        (i.checkValueInTargets = function (a, b) {
            ...
            for (c = 0; c < f.length; c++)
                for (e = a[f[c]].values, d = 0; d < e.length; d++) if (b(e[d].value)) return !0;
            return !1;
        }),
        ...
        (i.loadFromArgs = function (a) {
            ...
            a.data
                ...
                : a.url
                  ? b.convertUrlToData(a.url, a.mimeType, a.headers, a.keys, function (c) {
                    ...
                    ? (c.svg
                      ...
                      void a.forEach(function (a) {
                          ((c.withoutFadeIn[a] = !1),
                              c.legend &&
                                  c.legend
                                      .selectAll('.' + l.legendItem + c.getTargetSelectorSuffix(a))
                                      .remove(),
                    ...
                    : ((!h.isCustomX() && !h.isTimeSeries()) || h.isCategorized()
                          ...
                          : (h.updateXs(),
                            ...
                            (g = function (a) {
                                ...
                                return null === b && null === c
                                    ? 0
                                    : (null === b && (b = h.x.domain()[0]), (h.x(d) + h.x(b)) / 2);
                            })),
        ...
        (i.generateEventRectsForSingleX = function (a) {
            ...
            a.append('rect')
                ...
                .style(
                    'cursor',
                    d.data_selection_enabled && d.data_selection_grouped ? 'pointer' : null,
                )
        ...
        (i.getCircles = function (a, b) {
            var c = this;
            return (
                b ? c.main.selectAll('.' + l.circles + c.getTargetSelectorSuffix(b)) : c.main
        ...
        (i.getBars = function (a, b) {
            var c = this;
            return (
                b ? c.main.selectAll('.' + l.bars + c.getTargetSelectorSuffix(b)) : c.main
        ...
        (i.updateGrid = function (a) {
            ...
            (e.grid.style('visibility', e.hasArcType() ? 'hidden' : 'visible'),
                ...
                b
                    ...
                    .attr('dy', -5)
                    .style('opacity', 0),
                e.xgridLines.exit().transition().duration(a).style('opacity', 0).remove(),
                ...
                e.ygridLines
                    ...
                    .style('opacity', 1),
                e.ygridLines.exit().transition().duration(a).style('opacity', 0).remove());
        }),
        ...
        (i.generateGridData = function (a, b) {
            ...
            if ('year' === a)
                for (
                    c = g.getXDomain(), d = c[0].getFullYear(), e = c[1].getFullYear(), f = d;
                    e >= f;
                    f++
                )
            ...
            if (0 === l.data_groups.length)
                ...
                a.sort(function (a, b) {
                    ...
                    return (
                        c > 0 &&
                            d > 0 &&
                            ((c = a ? q.indexOf(a.id) : null), (d = b ? q.indexOf(b.id) : null)),
                        p ? c - d : d - c
                    );
                });
            }
        ...
        (i.tooltipPosition = function (a, b, c, d) {
            ...
            return (
                m
                    ? ((f = (j.width - (j.isLegendRight ? j.getLegendWidth() : 0)) / 2 + n[0]),
                      (h = j.height / 2 + n[1] + 20))
                    : ((e = j.getSvgLeft(!0)),
                      k.axis_rotated
                          ? ((f = e + n[0] + 100),
            ...
            function d(a, b) {
                return (
                    y.legendItemTextBox[b] ||
                        (y.legendItemTextBox[b] = y.getTextRect(a.textContent, l.legendItem, a)),
                    y.legendItemTextBox[b]
                );
            }
            function e(b, c, e) {
        ...
        (i.xForTitle = function () {
            ...
            return (a =
                d.indexOf('right') >= 0
                    ? b.currentWidth -
                      b.getTextRect(b.title.node().textContent, b.CLASS.title, b.title.node())
                          .width -
        ...
        (i.yForTitle = function () {
            ...
            return (
                ...
                a.getTextRect(a.title.node().textContent, a.CLASS.title, a.title.node()).height
            );
        }),
        ...
        (f.prototype.getYAxis = function (a, b, c, d, e, f, h) {
            ...
            return (
                i.isTimeSeriesY()
                    ? l.ticks(i.d3.time[j.axis_y_tick_time_value], j.axis_y_tick_time_interval)
                    : l.tickValues(d),
                l
            );
        }),
        ...
        (i.updateRadius = function () {
            ...
            ((a.radiusExpanded = Math.min(a.arcWidth, a.arcHeight) / 2),
                ...
                (a.innerRadius =
                    a.hasType('donut') || a.hasType('gauge') ? a.radius * a.innerRadiusRatio : 0));
        }),
        ...
        (i.updateRegion = function (a) {
            ...
            (b.region.style('visibility', b.hasArcType() ? 'hidden' : 'visible'),
                (b.mainRegion = b.main
                    ...
                    .selectAll('.' + l.region)
                    .data(c.regions)),
                b.mainRegion.enter().append('g').append('rect').style('fill-opacity', 0),
                b.mainRegion.attr('class', b.classRegion.bind(b)),
                b.mainRegion.exit().transition().duration(a).style('opacity', 0).remove());
        }),
                ...
                (f.data_selection_multiple ||
                    d.main
                        .selectAll(
                            '.' +
                                l.shapes +
                                (f.data_selection_grouped ? d.getTargetSelectorSuffix(b.id) : ''),
                        )
                        .selectAll('.' + l.shape)
                        .each(function (a, b) {
                            var c = e.select(this);
        ...
        (i.initSubchart = function () {
            ...
            (c.style('visibility', d),
                c.append('g').attr('clip-path', a.clipPathForSubchart).attr('class', l.chart),
                c
                    .select('.' + l.chart)
                    .append('g')
                    .attr('class', l.chartBars),
        ...
        (i.updateBarForSubchart = function (a) {
            ...
            ((b.contextBar = b.context
                ...
                b.contextBar.exit().transition().duration(a).style('opacity', 0).remove());
        }),
        ...
        (i.updateLineForSubchart = function (a) {
            ...
            ((b.contextLine = b.context
                ...
                b.contextLine.exit().transition().duration(a).style('opacity', 0).remove());
        }),
        ...
        (i.updateAreaForSubchart = function (a) {
            ...
            ((b.contextArea = b.context
                ...
                b.contextArea.exit().transition().duration(a).style('opacity', 0).remove());
        }),
    ...
    ((h.focus = function (a) {
        ...
        (h.unload = function (a) {
            ...
            ((a = a || {}),
                ...
                b.unload(b.mapToTargetIds(a.ids), function () {
                    (b.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0, withLegend: !0 }),
                        a.done && a.done());
                }));
        }),
        (h.flow = function (a) {
                    ...
                    d
                        ...
                        .each(function () {
                            (C.add(b.axes.x.transition().call(b.xAxis)),
                                ...
                                C.add(F.filter(b.isRegionOnX).transition().attr('transform', f)),
        ...
        (h.regions.add = function (a) {
            var b = this.internal,
                c = b.config;
            return a
                ? ((c.regions = c.regions.concat(a)), b.redrawWithoutRescale(), c.regions)
                : c.regions;
        }),
            ...
            ('SVGPathSeg' in a ||
                ...
                'SVGPathSegList' in a ||
                    ...
                    Object.defineProperty(SVGPathElement.prototype, 'pathSegList', {
                        get: function () {
                            return (
                                this._pathSegList || (this._pathSegList = new SVGPathSegList(this)),
                                this._pathSegList
                            );
                        },
                        enumerable: !0,
