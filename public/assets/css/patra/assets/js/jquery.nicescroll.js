/* jquery.nicescroll 3.5.0 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */ (function (e) {
    ...
    var A = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        Q = function (h, c) {
            ...
            this.ishwscroll =
                (this.canhwscroll = g.hastransform && b.opt.hwacceleration) && b.haswrapper;
            ...
            this.updateScrollBar = function (d) {
                if (b.ishwscroll)
                    ...
                    b.locked ||
                        b.rail.css({ top: f, left: g, height: d ? d.h : b.win.innerHeight() });
                    b.zoom &&
                        b.zoom.css({
                            top: f + 1,
                ...
                if (!b.ispage || (!g.cantouch && !g.isieold && !g.isie9mobile)) {
                    ...
                    if (g.isie9mobile)
                        ...
                        if (g.cantouch || b.opt.touchbehavior)
                            ((b.onpreventclick = function (d) {
                                ...
                                b.opt.grabcursorenabled &&
                                    g.cursorgrabvalue &&
                                    (b.css(b.ispage ? b.doc : b.win, { cursor: g.cursorgrabvalue }),
                        ...
                        !g.cantouch && !b.opt.touchbehavior
                            ? (b.bind(g.hasmousecapture ? b.win : document, 'mouseup', b.onmouseup),
                ...
                'mousewheel' == c
                    ...
                    : k.addEventListener
                      ? (g.cantouch &&
                        ...
                        b._bind(k, c, f, e || !1),
                        g.cantouch && 'mouseup' == c && b._bind(k, 'touchcancel', f, e || !1))
                ...
                ? b.ishwscroll && g.hastransition && b.opt.usetransition
                    ? ((this.prepareTransition = function (d, c) {
                      ...
                      (this.doScrollPos = function (c, e, f) {
                          var k = b.getScrollTop(),
                              l = b.getScrollLeft();
                          (0 > (b.newscrolly - k) * (e - k) || 0 > (b.newscrollx - l) * (c - l)) &&
                              b.cancelScroll();
                    ...
                    : ((this.doScrollLeft = function (c, g) {
                      ...
                      (this.doScrollPos = function (c, g, f) {
                          ...
                          var k = b.getScrollTop(),
                              l = b.getScrollLeft();
                          (0 > (b.newscrolly - k) * (g - k) || 0 > (b.newscrollx - l) * (c - l)) &&
                              b.cancelScroll();
                          b.newscrolly = g;
                          b.newscrollx = c;
                          ...
                          if (!b.timer) {
                              ...
                              e();
                              ((k == b.page.maxh && g >= k) || (l == b.page.maxw && c >= l)) &&
                                  b.checkContentSize();
                              b.noticeCursor();
                          }
                      }),
