                                        ...
                                        if ('element' !== T) {
                                            ...
                                            if (((k.currentValue = A), 'tween' === T)) m = A;
                                                ...
                                                (x.Hooks.registered[T] &&
                                                    (i(w).rootPropertyValueCache[j] = x
                                                        .Normalizations.registered[j]
...
!(function (a, b, c, d) {
    ...
    function gb(a) {
        for (var b = [], c = 0; c < a.pointers.length;)
            ((b[c] = { clientX: h(a.pointers[c].clientX), clientY: h(a.pointers[c].clientY) }),
                c++);
    ...
    (a.MSPointerEvent &&
        ((ub = 'MSPointerDown'), (vb = 'MSPointerMove MSPointerUp MSPointerCancel')),
        p(wb, ab, {
            handler: function (a) {
                var b = this.store,
                    c = !1,
