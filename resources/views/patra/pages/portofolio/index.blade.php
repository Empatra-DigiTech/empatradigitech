                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex mb-1">
                                                <a href="{{route('patra.portofolio.show',$row->id)}}" class="btn btn-success btn-sm mr-1"><i class="fa fa-address-card"></i> Detail</a>
                                                <a href="{{route('patra.portofolio.edit',$row->id)}}" class="btn btn-primary btn-sm mr-1"><i class="fa fa-edit"></i> Edit</a>
...
@include("patra.pages.portofolio.modal.index")
    ...
    $(function(){
        ...
        $(document).on("click",".btn-delete",function(){
            ...
            if(confirm("Apakah anda yakin ingin menghapus data ini ?")){
                $("#frmDelete").attr("action", "{{ route('patra.portofolio.destroy', '_id_') }}".replace("_id_", id));
