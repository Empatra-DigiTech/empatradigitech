...
@section("css")
<!-- Datetime picker -->
<link rel="stylesheet" href="{{URL::to('/')}}/assets/css/patra/assets/plugins/datetimepicker/jquery.datetimepicker.css">
@endsection
...
<div class="row">
    <div class="col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="{{route('patra.users.store')}}" method="post" autocomplete="off" onsubmit="confirm('Apakah anda yakin ingin mengirim data ini?')" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="{{route('patra.users.index')}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
...
@section("script")
    ...
    <!-- Datetimepicker -->
    <script src="{{URL::to('/')}}/assets/js/patra/plugins/moment/moment.min.js"></script>
    <script src="{{URL::to('/')}}/assets/js/patra/plugins/datetimepicker/jquery.datetimepicker.min.js"></script>
    <script src="{{URL::to('/')}}/assets/js/patra/plugins/axios/axios.min.js"></script>
    <script>
        $(function(){
