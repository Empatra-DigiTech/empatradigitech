<head>
  ...
  <!-- css yudo-->
    <link href="{{URL::to('/')}}/assets/css/patra/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link href="{{URL::to('/')}}/assets/css/patra/assets/css/icons.css" rel="stylesheet" type="text/css">
