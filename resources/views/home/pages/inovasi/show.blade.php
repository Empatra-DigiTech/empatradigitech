        ...
        <div class="row detail-row g-0">
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                <div class="detail-info">
                    ...
                    @php
                        $waMessage = "Halo Empatra DigiTech, saya tertarik dengan produk \"{$result->title}\", boleh minta info lebih lanjut?";
                        $waLink = "https://wa.me/6285151811055?text=" . urlencode($waMessage);
                    @endphp
                    <a href="{{ $waLink }}" target="_blank" rel="noopener" class="btn-showcase detail-cta">
